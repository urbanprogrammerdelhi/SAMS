...
<body class="login-class" style="background-color: #2E6292;">
    <form id="form1" runat="server">
            ...
            <table style="padding-left: 15px; width: 100%; background-color: white;" class="table-responsive">
                <tr style="background-color: white; width: 80%">
                  <td class="auto-style4" style="padding-left: 15px" colspan="3">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/ifm.png" Width="1441px" Height="150px"  class="img-responsive"  Visible="false" ImageAlign="Middle"/>
                </td>
                </tr>
            </table>
        </div>
            ...
            <table class="table-responsive-xl form-group">
                <tr class="table-info">
                    ...
                    <td style="text-align: right; padding-left: 80px;" class="auto-style1">
                         <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/iam.png" Width="243px" Height="150px"  class="img-responsive"  Visible="true" ImageAlign="Middle"/>
                ...
                <BotDetect:Captcha ID="SampleCaptcha" runat="server" BackColor="DeepSkyBlue" ForeColor="White" Width="100px"></BotDetect:Captcha>   
                        ...
                        <div class="input-group input-lg">
                            <asp:Button ID="BtnSubmit" runat="server" Text="Sign In" CssClass="form-control btn btn-success" OnClick="btnLogin_onclick"></asp:Button>
        ...
        EnableClientScript="true" SetFocusOnError="true" Visible="false">
                        ...
                        <asp:HyperLink ID="btnlink" Text="IAM360" Target="http://www.v19tech.in/" Style="font-size: large; color: white;" runat="server" NavigateUrl="http://www.v19tech.in/iams360.html" Font-Bold="true"></asp:HyperLink>
           
                     
                        <p class="cssLoginFooterText" >
                 <asp:Label ID="lblSoftwareVersion" runat="server" visible="true" Style="font-size: small; color: white;"></asp:Label>&nbsp;
            <asp:Label ID="lblRelease" runat="server" visible="true" Style="font-size: small; color: white;"></asp:Label>&nbsp;
