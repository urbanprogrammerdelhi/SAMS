<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="Rpt_EmployeeWorkHistoryDetail.aspx.cs" Inherits="Rpt_EmployeeWorkHistoryDetail" Title="<%$ Resources:Resource, AppTitle %>" %>
                        ...
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="PanelCustomer" Width="800px" BorderWidth="0px" runat="server">
                                <table width="800px" border="0" cellpadding="1" cellspacing="0">
                                    <tr>
                                        <td align="right" style="width: 200px">
                                            <asp:Label ID="lblCustomer" runat="server" Text="<%$ Resources:Resource, Customer %>" 
                                                CssClass="cssLable"></asp:Label>
                                        </td>
                                        <td align="left" colspan="3">
                                            <telerik:RadComboBox ID="ddlClientCode" runat="server" Width="350px" MaxHeight="350px"
                            ...
                            <asp:Panel ID="PanelAsmt" Width="800px" BorderWidth="0px" runat="server">
                                <table width="800px" border="0" cellpadding="1" cellspacing="0">
                                    <tr>
                                        <td align="right" style="width: 200px">
                                            <asp:Label ID="lblAsmt" runat="server" Text="<%$ Resources:Resource, Asmt %>" 
                                                CssClass="cssLable"></asp:Label>
                                        </td>
                                        <td align="left" colspan="3">
                                            <telerik:RadComboBox ID="ddlAsmtId" runat="server" Width="350px" MaxHeight="350px"
                                                AutoPostBack="true" Filter="StartsWith"  OnSelectedIndexChanged="ddlAsmtId_SelectedIndexChanged">
                                            </telerik:RadComboBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <asp:Panel ID="PanelConfirmDuty" Width="800px" BorderWidth="0px" runat="server" Visible="false">
                                <table width="800px" border="0" cellpadding="1" cellspacing="0">
                                    <tr>
                                        <td align="right" style="width: 200px">
                                            <asp:Label ID="lblConfirmDuty" CssClass="cssLable" runat="server" Text="<%$ Resources:Resource, ConfirmDuty %>"></asp:Label>
                                        </td>
                                        <td align="left" colspan="3">
                                            <telerik:RadComboBox ID="ddlConfirmDuty" runat="server" Width="155px" MaxHeight="350px" Filter="StartsWith">
                                                <Items>
                                                    <telerik:RadComboBoxItem Text="<%$Resources:Resource, All %>" Value="All" Selected="true"/>
                                                    <telerik:RadComboBoxItem Text="<%$Resources:Resource, Confirmed %>" Value="1" />
                                                    <telerik:RadComboBoxItem Text="<%$Resources:Resource, NotConfirmed %>" Value="0" />
                                                </Items>
                                            </telerik:RadComboBox>
                                        </td>
                                    </tr>
