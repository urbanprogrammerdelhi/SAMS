<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaxExportPDF.aspx.cs" Inherits="MaxExportPDF" %>
...
<%--                            <AjaxToolKit:CalendarExtender ID="CEDutyDate" Format="dd-MMM-yyyy" runat="server"
            ...
            <div id="divGV" runat="server" visible="true">
                ...
                <br />
                <br />
                <div id="divspoc" runat="server" visible="true">
                ...
                <asp:GridView ID="gvAttendence" Width="100%" CssClass="GridViewStyle" PageSize="45" runat="server" AllowPaging="true" CellPadding="1" GridLines="None"
                    AutoGenerateColumns="False" OnRowDataBound="gvAttendence_RowDataBound" ShowFooter="True" OnPageIndexChanging="gvAttendence_PageIndexChanging" Visible="true">
