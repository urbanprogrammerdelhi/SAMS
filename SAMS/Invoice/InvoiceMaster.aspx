<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="InvoiceMaster.aspx.cs" Inherits="Sales_InvoiceMaster"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox Width="80px" ID="txtPostingDate" CssClass="csstxtboxRequired" MaxLength="16"
                                                    runat="server"></asp:TextBox>
                                                <asp:HyperLink Style="vertical-align: top;" ID="IMGPostingDate" runat="server" ImageUrl="../Images/pdate.gif"></asp:HyperLink>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator13" ValidationGroup="vgCSave"
                                                    ControlToValidate="txtPostingDate" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                                            </td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            <td align="left">
                                                <asp:GridView Width="950px" ID="gvSaleOrderDetails" CssClass="GridViewStyle" runat="server"
                                                    ...
                                                    OnRowDataBound="gvSaleOrderDetails_RowDataBound" OnRowUpdating="gvSaleOrderDetails_RowUpdating1">
                                                ...
                                                <asp:GridView Width="930" ID="gvSOItemDetails" CssClass="GridViewStyle" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-Width="100px" FooterStyle-Width="100px" ItemStyle-Width="100px">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblgvRate" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:n3}", DataBinder.Eval(Container.DataItem, "Rate"))%>'></asp:Label>
                                                            </ItemTemplate>
                                                            <%--<EditItemTemplate>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="left" width="18%">
                        <asp:TextBox Width="150px" ID="txtSubTotal" CssClass="csstxtboxRequired" MaxLength="16"
                            runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" width="18%">
                        <asp:TextBox Width="150px" ID="txtTax" CssClass="csstxtboxRequired" MaxLength="16"
                ...
                <tr>
                    ...
                    <td align="left" width="18%">
                        <asp:TextBox Width="150px" ID="txtGrandTotal" CssClass="csstxtboxRequired" MaxLength="16"
                            runat="server"></asp:TextBox>
