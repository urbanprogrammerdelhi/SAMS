<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="CPStockDashboard.aspx.cs" Inherits="APSInventory_CPStockDashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <asp:Panel ScrollBars="Auto" ID="PanelAssetChecklist" Font-Bold="True" ForeColor="Red" Height="150px" runat="server" GroupingText="Center Point Stock Dashboard">
                <table align="center" width="100%" border="0" cellspacing="0px" cellpadding="0px">
                     <tr>
                        <td style="text-align: right;">
                            <asp:Label ID="lblOffice" CssClass="cssLable" runat="server" Text="Select Center point : " Font-Bold="true" Font-Size="Medium" ForeColor="Black" ></asp:Label>
                        </td>
                        <td style="text-align: left;">
                            <asp:DropDownList ID="ddloffice" runat="server" CssClass="csstxtbox" Width="150px" >
                                   <asp:ListItem Text="All Center Point" Value="All"></asp:ListItem> 
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:DropDownList ID="ddlItemDescription" runat="server" CssClass="csstxtbox" Width="150px" ></asp:DropDownList>
                        </td>
                          </tr>  
                ...
                <asp:GridView Width="100%" ID="gvItemLedger" CssClass="GridViewStyle" runat="server" ShowFooter="True" AllowPaging="True" PageSize="15" CellPadding="1" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Equipment Name" HeaderStyle-ForeColor="White">
                         ...
                         <asp:TemplateField HeaderText="CP Name" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
                              <asp:Label ID="lblStockDesc" Width="100px" Style="word-break: break-all;  " Font-Bold="true" Font-Size="Medium" ForeColor="Black"  CssClass="cssLabel" runat="server" Text='<%# Bind("CP") %>'></asp:Label>
                           </ItemTemplate>
                            <HeaderStyle CssClass="cssLabelHeader" Width="100px" />
                            <ItemStyle Width="100px" />
                            <FooterStyle Width="100px" />
                         ...
                         <asp:TemplateField HeaderText="Hub Name" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
                              <asp:Label ID="lblStockDeptName" Width="100px" Style="word-break: break-all;  " Font-Bold="true" Font-Size="Medium" ForeColor="Black"  CssClass="cssLabel" runat="server" Text='<%# Bind("[HubName]") %>'></asp:Label>
                           </ItemTemplate>
                            <HeaderStyle CssClass="cssLabelHeader" Width="100px" />
                            <ItemStyle Width="100px" />
                            <FooterStyle Width="100px" />
