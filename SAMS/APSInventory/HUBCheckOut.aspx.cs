...
public partial class APSInventory_HUBCheckOut : BasePage
{
    ...
    protected void btn1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT(Label1.Text, txtdate1.Text, txtqty1.Text, txtVendor1.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value,ddlHUB.SelectedItem.Value);
                txtVendor1.Text = "";
    ...
    protected void btn2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label2.Text, txtdate2.Text, txtqty2.Text, txtVendor2.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor2.Text = "";
    ...
    protected void btn3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label3.Text, txtdate3.Text, txtqty3.Text, txtVendor3.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor3.Text = "";
    ...
    protected void btn4_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label4.Text, txtdate4.Text, txtqty4.Text, txtVendor4.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor4.Text = "";
    ...
    protected void btn5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label5.Text, txtdate5.Text, txtqty5.Text, txtVendor5.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor5.Text = "";
    ...
    protected void btn6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label6.Text, txtdate6.Text, txtqty6.Text, txtVendor6.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor6.Text = "";
    ...
    protected void btn7_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label7.Text, txtdate7.Text, txtqty7.Text, txtVendor7.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor7.Text = "";
    ...
    protected void btn8_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label8.Text, txtdate8.Text, txtqty8.Text, txtVendor8.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor8.Text = "";
    ...
    protected void btn9_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label9.Text, txtdate9.Text, txtqty9.Text, txtVendor9.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor9.Text = "";
    ...
    protected void btn10_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label10.Text, txtdate10.Text, txtqty10.Text, txtVendor10.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor10.Text = "";
    ...
    protected void btn11_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label11.Text, txtdate11.Text, txtqty11.Text, txtVendor11.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor11.Text = "";
    ...
    protected void btn12_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label12.Text, txtdate12.Text, txtqty12.Text, txtVendor12.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor12.Text = "";
    ...
    protected void btn13_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT(Label13.Text, txtdate13.Text, txtqty13.Text, txtVendor13.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor13.Text = "";
    ...
    protected void btn14_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label14.Text, txtdate14.Text, txtqty14.Text, txtVendor14.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor14.Text = "";
    ...
    protected void btn15_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label15.Text, txtdate15.Text, txtqty15.Text, txtVendor15.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor15.Text = "";
    ...
    protected void btn16_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label16.Text, txtdate16.Text, txtqty16.Text, txtVendor16.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor16.Text = "";
    ...
    protected void btn17_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label17.Text, txtdate17.Text, txtqty17.Text, txtVendor17.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor17.Text = "";
    ...
    protected void btn18_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label18.Text, txtdate18.Text, txtqty18.Text, txtVendor18.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor18.Text = "";
    ...
    protected void btn19_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label19.Text, txtdate19.Text, txtqty19.Text, txtVendor19.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor19.Text = "";
    ...
    protected void btn20_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label20.Text, txtdate20.Text, txtqty20.Text, txtVendor20.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor20.Text = "";
    ...
    protected void btn21_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label21.Text, txtdate21.Text, txtqty21.Text, txtVendor21.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor21.Text = "";
    ...
    protected void btn22_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label22.Text, txtdate22.Text, txtqty22.Text, txtVendor22.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor22.Text = "";
    ...
    protected void btn23_Click(object sender, EventArgs e)
    {
        ...
        try
        {
               ds = objAssetMgmt.HUBMaterialOUT( Label23.Text, txtdate23.Text, txtqty23.Text, txtVendor23.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor23.Text = "";
    ...
    protected void btn24_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                 ds = objAssetMgmt.HUBMaterialOUT( Label24.Text, txtdate24.Text, txtqty24.Text, txtVendor24.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor24.Text = "";
    ...
    protected void btn25_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                  ds = objAssetMgmt.HUBMaterialOUT( Label25.Text, txtdate25.Text, txtqty25.Text, txtVendor25.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor25.Text = "";
    ...
    protected void btn26_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                    ds = objAssetMgmt.HUBMaterialOUT( Label26.Text, txtdate26.Text, txtqty26.Text, txtVendor26.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor26.Text = "";
    ...
    protected void btn27_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label27.Text, txtdate27.Text, txtqty27.Text, txtVendor27.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor27.Text = "";
    ...
    protected void btn28_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label28.Text, txtdate28.Text, txtqty28.Text, txtVendor28.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor28.Text = "";
    ...
    protected void btn29_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                 ds = objAssetMgmt.HUBMaterialOUT( Label29.Text, txtdate29.Text, txtqty29.Text, txtVendor29.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor29.Text = "";
    ...
    protected void btn30_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                   ds = objAssetMgmt.HUBMaterialOUT( Label30.Text, txtdate30.Text, txtqty30.Text, txtVendor30.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor30.Text = "";
    ...
    protected void btn31_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT(Label31.Text, txtdate31.Text, txtqty31.Text, txtVendor31.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor31.Text = "";
    ...
    protected void btn32_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label32.Text, txtdate32.Text, txtqty32.Text, txtVendor32.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor32.Text = "";
    ...
    protected void btn33_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label33.Text, txtdate33.Text, txtqty33.Text, txtVendor33.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor33.Text = "";
    ...
    protected void btn34_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                ds = objAssetMgmt.HUBMaterialOUT( Label34.Text, txtdate34.Text, txtqty34.Text, txtVendor34.Text, "OUT", BaseLocationAutoID, BaseUserID, ddlBranch.SelectedItem.Value, ddlHUB.SelectedItem.Value);
                txtVendor34.Text = "";
