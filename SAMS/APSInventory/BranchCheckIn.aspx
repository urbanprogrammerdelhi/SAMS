<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="BranchCheckIn.aspx.cs" Inherits="APSInventory_BranchCheckIn" %>
...
tr:nth-child(even) {
  background-color: #D6EEEE;
    ...
    <asp:Label ID="lblheader" runat="server" Text="Branch Material IN Form" Font-Bold="true" ForeColor="Red" Font-Size="Large" style="align-self:center" ></asp:Label>
   <%--<br />
      <br />
   <asp:Label ID="lblheader1" runat="server" Text="Select Branch for Material's IN -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
    <asp:DropDownList ID="ddlBranch" runat="server" Font-Bold="true" ForeColor="Black" Width="350px" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged" AutoPostBack="true" >
   ...
   <asp:Label ID="Label35" runat="server" Text="Select HUB  -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
    <asp:DropDownList ID="ddlHub" runat="server" Font-Bold="true" ForeColor="Black" Width="350px"  >
     ...
     <br />
      <br />
   <asp:Label ID="lblheader1" runat="server" Text="Select HUB  -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
    <asp:DropDownList ID="ddlHub" runat="server" Font-Bold="true" ForeColor="Black" Width="350px" OnSelectedIndexChanged="ddlHUB_SelectedIndexChanged" AutoPostBack="true" >
     
    </asp:DropDownList>
   
     <br />
      <br />
     <asp:Label ID="Label35" runat="server" Text="Select Branch District -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
    <asp:DropDownList ID="ddlDistrict" runat="server" Font-Bold="true" ForeColor="Black" Width="350px" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged" AutoPostBack="true" >
     
    </asp:DropDownList>
   
     <br />
      <br />
     <asp:Label ID="Label36" runat="server" Text="Select Branch City -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
    <asp:DropDownList ID="ddlCity" runat="server" Font-Bold="true" ForeColor="Black" Width="350px"  OnSelectedIndexChanged="ddlCity_SelectedIndexChanged" AutoPostBack="true">
     
    </asp:DropDownList>
   
     <br />
      <br />
     <asp:Label ID="Label37" runat="server" Text="Select Branch Code n Name where Material's IN -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
    <asp:DropDownList ID="ddlBranch" runat="server" Font-Bold="true" ForeColor="Black" Width="350px" >
     
    </asp:DropDownList>
   <asp:Button ID="BtnOneShot" runat="server" Text="Material IN Single Click" OnClick="BtnOneShot_Click" CssClass="cssButton" />
     <br />
      <br />  
    <table >
        ...
        <tr>
            <td style="background-color:yellow;color:red;font-size:large;align-content:center" ><strong>S.No&nbsp;&nbsp;</strong></td>
             ...
             <td style="background-color:yellow;color:red;font-size:large" ><strong>Remarks</strong></td>
         ...
         <tr>
          ...
          <td style="color:black">   <strong>32 Zone Integrated alarm panel</strong></td>
             ...
             <td><asp:TextBox ID="txtqty1" runat="server" Enabled="false" Text="1" ></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty2" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty3" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty4" runat="server" Enabled="false" Text="8"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty5" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty6" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td class="auto-style2"><asp:TextBox ID="txtqty7" runat="server" Enabled="false" Text="3"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty8" runat="server" Enabled="false" Text="6"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty9" runat="server" Enabled="false" Text="10"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty10" runat="server" Enabled="false" Text="3"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty11" runat="server" Enabled="false" Text="3"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty12" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty13" runat="server" Enabled="false" Text="5"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty14" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty15" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty16" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty17" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty18" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty19" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty20" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty21" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty22" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty23" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty24" runat="server" Enabled="false" Text="4"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty25" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty26" runat="server" Enabled="false" Text="4"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty27" runat="server" Enabled="false" Text="1"> </asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty28" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
             ...
             <td><asp:TextBox ID="txtqty29" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
        ...
        <tr>
             ...
             <td><asp:TextBox ID="txtqty30" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
        ...
        <tr>
             ...
             <td><asp:TextBox ID="txtqty31" runat="server" Enabled="false" Text="25"></asp:TextBox></td>
          ...
          <tr>
             ...
             <td><asp:TextBox ID="txtqty32" runat="server" Enabled="false" Text="25"></asp:TextBox></td>
          ...
          <tr>
             ...
             <td><asp:TextBox ID="txtqty33" runat="server" Enabled="false" Text="2"></asp:TextBox></td>
          ...
          <tr>
             ...
             <td><asp:TextBox ID="txtqty34" runat="server" Enabled="false" Text="1"></asp:TextBox></td>
