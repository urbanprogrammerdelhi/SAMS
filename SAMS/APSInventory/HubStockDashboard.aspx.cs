...
public partial class APSInventory_HubStockDashboard : BasePage
{
    static int dtflag;
    ...
    private void FillddlHUB()
    {
        ...
        ddloffice.DataSource = objAssetManagement.GetHubNameWithID();
        ddloffice.DataTextField = "HubName";
        ddloffice.DataValueField = "AutoId";
        ddloffice.DataBind();
        ddloffice.Items.Insert(0, new ListItem("All Hub", "All"));
    ...
    private void FillgvOrderGrid()
    {
        try
        {
            ...
            dtflag = 1;
            dsAssetMaster = objAssetMgmt.GetHUBItemStock(ddlItemDescription.SelectedItem.Value, ddloffice.SelectedItem.Value, Convert.ToInt32(BaseLocationAutoID));
    ...
    private void FillgvGridItemLedger(string ItemName)
    {
        try
        {
            ...
            var dtAssetMaster = new DataTable();
            dtflag = 1;
            dsAssetMaster = objAssetMgmt.GetItemStockLedgerHub(ItemName.ToString(), ddloffice.SelectedItem.Value, Convert.ToInt32(BaseLocationAutoID));
