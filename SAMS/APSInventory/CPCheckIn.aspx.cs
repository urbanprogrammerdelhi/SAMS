...
public partial class APSInventory_CPCheckIn : BasePage
{
    ...
    protected void btn1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label1.Text, txtdate1.Text, txtqty1.Text, txtVendor1.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor1.Text = "";
            txtqty1.Text = "";
    ...
    protected void btn2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label2.Text, txtdate2.Text, txtqty2.Text, txtVendor2.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor2.Text = "";
            txtqty2.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label3.Text, txtdate3.Text, txtqty3.Text, txtVendor3.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor3.Text = "";
            txtqty3.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn4_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label4.Text, txtdate4.Text, txtqty4.Text, txtVendor4.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor4.Text = "";
            txtqty4.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label5.Text, txtdate5.Text, txtqty5.Text, txtVendor5.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor5.Text = "";
            txtqty5.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label6.Text, txtdate6.Text, txtqty6.Text, txtVendor6.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor6.Text = "";
            txtqty6.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn7_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label7.Text, txtdate7.Text, txtqty7.Text, txtVendor7.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor7.Text = "";
            txtqty7.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn8_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label8.Text, txtdate8.Text, txtqty8.Text, txtVendor8.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor8.Text = "";
            txtqty8.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn9_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label9.Text, txtdate9.Text, txtqty9.Text, txtVendor9.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor9.Text = "";
            txtqty9.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn10_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label10.Text, txtdate10.Text, txtqty10.Text, txtVendor10.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor10.Text = "";
            txtqty10.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn11_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label11.Text, txtdate11.Text, txtqty11.Text, txtVendor11.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor11.Text = "";
            txtqty11.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn12_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label12.Text, txtdate12.Text, txtqty12.Text, txtVendor12.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor12.Text = "";
            txtqty12.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn13_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label13.Text, txtdate13.Text, txtqty13.Text, txtVendor13.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor13.Text = "";
            txtqty13.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn14_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label14.Text, txtdate14.Text, txtqty14.Text, txtVendor14.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor14.Text = "";
            txtqty14.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn15_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label15.Text, txtdate15.Text, txtqty15.Text, txtVendor15.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor15.Text = "";
            txtqty15.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn16_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label16.Text, txtdate16.Text, txtqty16.Text, txtVendor16.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor16.Text = "";
            txtqty16.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn17_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label17.Text, txtdate17.Text, txtqty17.Text, txtVendor17.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor17.Text = "";
            txtqty17.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn18_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label18.Text, txtdate18.Text, txtqty18.Text, txtVendor18.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor18.Text = "";
            txtqty18.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn19_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label19.Text, txtdate19.Text, txtqty19.Text, txtVendor19.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor19.Text = "";
            txtqty19.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn20_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label20.Text, txtdate20.Text, txtqty20.Text, txtVendor20.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor20.Text = "";
            txtqty20.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn21_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label21.Text, txtdate21.Text, txtqty21.Text, txtVendor21.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor21.Text = "";
            txtqty21.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn22_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label22.Text, txtdate22.Text, txtqty22.Text, txtVendor22.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor22.Text = "";
            txtqty22.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn23_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label23.Text, txtdate23.Text, txtqty23.Text, txtVendor23.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor23.Text = "";
            txtqty23.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn24_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label24.Text, txtdate24.Text, txtqty24.Text, txtVendor24.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor24.Text = "";
            txtqty24.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn25_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label25.Text, txtdate25.Text, txtqty25.Text, txtVendor25.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor25.Text = "";
            txtqty25.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn26_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label26.Text, txtdate26.Text, txtqty26.Text, txtVendor26.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor26.Text = "";
            txtqty26.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn27_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label27.Text, txtdate27.Text, txtqty27.Text, txtVendor27.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor27.Text = "";
            txtqty27.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn28_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label28.Text, txtdate28.Text, txtqty28.Text, txtVendor28.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor28.Text = "";
            txtqty28.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn29_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label29.Text, txtdate29.Text, txtqty29.Text, txtVendor29.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor29.Text = "";
            txtqty29.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn30_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label30.Text, txtdate30.Text, txtqty30.Text, txtVendor30.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor30.Text = "";
            txtqty30.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn31_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label31.Text, txtdate31.Text, txtqty31.Text, txtVendor31.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor31.Text = "";
            txtqty31.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn32_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label32.Text, txtdate32.Text, txtqty32.Text, txtVendor32.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor32.Text = "";
            txtqty32.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn33_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label33.Text, txtdate33.Text, txtqty33.Text, txtVendor33.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor33.Text = "";
            txtqty33.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
    ...
    protected void btn34_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ds = objAssetMgmt.CPMaterialIN(ddlCP.SelectedItem.Value, Label34.Text, txtdate34.Text, txtqty34.Text, txtVendor34.Text, "IN", BaseLocationAutoID, BaseUserID);
            txtVendor34.Text = "";
            txtqty34.Text = "";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Material Inserted Successfully!!')", true);
        }
