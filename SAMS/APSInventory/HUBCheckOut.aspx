<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="HUBCheckOut.aspx.cs" Inherits="APSInventory_HUBCheckOut" %>
...
tr:nth-child(even) {
  background-color: #D6EEEE;
    ...
    <asp:Label ID="lblheader" runat="server" Text="HUB Material Out Form" Font-Bold="true" ForeColor="Red" Font-Size="Large" style="align-self:center" ></asp:Label>
    <br />
      <br />
   <asp:Label ID="lblheader1" runat="server" Text="Select HUB for Material's OUT -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
    ...
    <asp:DropDownList ID="ddlCity" runat="server" Font-Bold="true" ForeColor="Black" Width="350px"  OnSelectedIndexChanged="ddlCity_SelectedIndexChanged" AutoPostBack="true">
     ...
     <br />
      <br />
     <asp:Label ID="Label37" runat="server" Text="Select Branch Code n Name -" Font-Bold="true" ForeColor="black" Font-Size="Medium" style="align-self:center" ></asp:Label>
