...
public partial class MonitorScreen_EmpDeviceRealTimeIncident : BasePage
{
    ...
    protected void FillgvRealTimeAtt()
    {
        ...
        int dtflag;
        dtflag = 1;
        string strPostAutoId = "0"; // 0 for all post
        ds = objNFC.BlDeviceEmpIncidentGet(BaseLocationAutoID, ddlClient.SelectedItem.Value.ToString(), ddlAsmt.SelectedItem.Value.ToString(), strPostAutoId, DateFormat(txtFromDate.Text), DateFormat(txtToDate.Text));
        dt = ds.Tables[0];
