<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="EmpDeviceRealTimeDuty.aspx.cs" Inherits="MonitorScreen_EmpDeviceRealTimeDuty" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="gvRealTimeAtt" CssClass="GridViewStyle" runat="server" Width="100%" OnRowDataBound="gvRealTimeAtt_RowDataBound"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrEmployeeImage" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, EmployeeImage %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
