<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="EmpDeviceRealTimeIncident.aspx.cs" Inherits="MonitorScreen_EmpDeviceRealTimeIncident" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="gvRealTimeAtt" CssClass="GridViewStyle" runat="server" Width="100%" 
        ShowFooter="false" ShowHeader="true" Visible="true" CellPadding="1" GridLines="None" AutoGenerateColumns="False" OnRowDataBound="gvRealTimeAtt_RowDataBound">
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrIncidentDate" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, IncidentDate %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblgvIncidentDate" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:dd-MMM-yyyy}",Eval("IncidentDate")) %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="200px" />
                <HeaderStyle Width="200px" />
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrIncidentTime" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, Time %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblgvIncidentTime" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:HH:mm}",Eval("IncidentDate")) %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="200px" />
                <HeaderStyle Width="200px" />
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrIncidentNotes" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, IncidentNotes %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblgvIncidentNotes" CssClass="cssLable" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "IncidentNotes").ToString()%>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="200px" />
                <HeaderStyle Width="200px" />
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrLatitude" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, Latitude %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblgvLatitude" CssClass="cssLable" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Latitude").ToString()%>'></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrLongitude" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, Longitude %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblgvLongitude" CssClass="cssLable" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Longitude").ToString()%>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="150px" />
                <HeaderStyle Width="150px" />
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrAltitude" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, Altitude %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblgvAltitude" CssClass="cssLable" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Altitude").ToString()%>'></asp:Label>
                </ItemTemplate>
                <ItemStyle Width="150px" />
                <HeaderStyle Width="150px" />
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
                    <asp:Label ID="lblgvhdrImage" CssClass="cssLabelHeader" runat="server" Text="<%$ Resources:Resource, Image %>"></asp:Label>
                </HeaderTemplate>
                <ItemTemplate>
                    <img alt="" id="imgEmpImage" height="75" width="75" runat="server" src='<%# DataBinder.Eval(Container.DataItem, "ImageBase64String").ToString()%>'/>
                </ItemTemplate>
                <ItemStyle Width="150px" />
                <HeaderStyle Width="150px" />
        </asp:TemplateField>
