<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="VehicleReport.aspx.cs" Inherits="SAMS_VehicleReport" %>
                ...
                <asp:GridView ID="gvAttendence" Width="100%" CssClass="GridViewStyle" PageSize="15" runat="server" AllowPaging="true" CellPadding="1" GridLines="None"
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="Vehicle No." HeaderStyle-ForeColor="White">
                        ...
                        <asp:TemplateField HeaderText="IN KM" HeaderStyle-Width="300px"
                            FooterStyle-Width="300px" ItemStyle-Width="300px">
                            <ItemTemplate>
                                <asp:Label ID="lblINKM" CssClass="cssLable" runat="server" Text='<%# Bind("[inkm]") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="OUT KM" HeaderStyle-Width="300px"
                            FooterStyle-Width="300px" ItemStyle-Width="300px">
                            <ItemTemplate>
                                <asp:Label ID="lblOUTKM" CssClass="cssLable" runat="server" Text='<%# Bind("Outkm") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
