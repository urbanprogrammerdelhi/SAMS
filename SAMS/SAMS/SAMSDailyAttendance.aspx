<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="SAMSDailyAttendance.aspx.cs" Inherits="SAMS_SAMSDailyAttendance" %>
                ...
                <table align="center" width="100%" border="0" cellspacing="1px" cellpadding="1px">
                    ...
                    <tr style="background-color: #D3E8F4">
                        ...
                        <td style="text-align: left;" class="auto-style3">
                            <asp:DropDownList AutoPostBack="true" CssClass="cssDropDown" Width="180px" ID="ddlClientCode" runat="server"
                     ...
                     <tr style="background-color: #D3E8F4">
                            ...
                            <asp:Label ID="Label2" CssClass="cssLabel" runat="server" Text="Total Count : " ForeColor="Green" Font-Size="Medium" Font-Bold="true" Width="100px"></asp:Label>
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblcount" Width="25px" CssClass="cssLabel" runat="server" ForeColor="Red" Font-Size="Large" Font-Bold="true">     </asp:Label>
                              <asp:Label ID="Label4" Width="10px" CssClass="cssLabel" runat="server" ForeColor="Black" Font-Size="Large" Font-Bold="true" Text="/">     </asp:Label>
                            <asp:Label ID="labeltotalcount" Width="15px" CssClass="cssLabel" runat="server" ForeColor="Green" Font-Size="Large" Font-Bold="true"></asp:Label>
