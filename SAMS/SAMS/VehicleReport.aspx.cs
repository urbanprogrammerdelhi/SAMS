...
public partial class SAMS_VehicleReport : BasePage
{
    static int flag;
    #region Properties
    ...
    protected void FillgvAttendence()
    {
        ...
        var dtflag = 1;
        ds = objAssetMgmt.GetVehicleReport(BaseLocationAutoID, txtDutyDate.Text.Trim());
        dt = ds.Tables[0];
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=VehicleReport-" + txtDutyDate.Text + ".xls");
        Response.Charset = "";
    ...
    protected void gvAttendence_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblOUTKM = (Label)e.Row.FindControl("lblOUTKM");
            lblOUTKM.ForeColor = System.Drawing.Color.Green;
            lblOUTKM.Font.Bold = true;
