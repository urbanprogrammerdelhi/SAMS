<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="PhotoDashboard.aspx.cs" Inherits="SAMS_PhotoDashboard" %>
                ...
                <asp:GridView ID="gvAttendence" Width="100%" CssClass="GridViewStyle" PageSize="10" runat="server" AllowPaging="true" CellPadding="1" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Resource,EmployeeName %>" HeaderStyle-ForeColor="White">
                         ...
                         <asp:TemplateField HeaderText="Cluster No." HeaderStyle-ForeColor="White">
                            <ItemTemplate>
