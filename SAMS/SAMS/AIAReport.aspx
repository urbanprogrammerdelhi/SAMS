<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AIAReport.aspx.cs" Inherits="SAMS_AIAReport" %>
            ...
            <div style="overflow: auto;">
                ...
                <table align="center" width="100%" border="0" cellspacing="1px" cellpadding="1px">
                    ...
                    <tr style="background-color: #D3E8F4">
                     ...
                     <td>
                           <asp:Label ID="LabelState" CssClass="cssLabel" runat="server" Text="State" Font-Bold="true"></asp:Label>
                     </td>
                        <td>
                            <asp:DropDownList ID="ddlstate" runat="server" CssClass="cssDropDown" OnSelectedIndexChanged="ddlstate_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </td>
                  ...
                  <td>
                           <asp:Label ID="LabelCity" CssClass="cssLabel" runat="server" Text="Branch" Font-Bold="true"></asp:Label>
                     </td>
                        <td>
                            <asp:DropDownList ID="ddlbranch" runat="server" CssClass="cssDropDown" OnSelectedIndexChanged="ddlbranch_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </td>
                              
                     
                                <td style="text-align: right;" class="auto-style8">
                            <asp:Label ID="Label3" CssClass="cssLabel" runat="server" Text="E.Code" Font-Bold="true"></asp:Label>
                        </td>
             ...
             <div >
                      ...
                      <asp:Button ID="btnAll" runat="server" OnClick="btnAll_Click" style="width:300px;height:70px;background-color:orange;font-size:medium;color:white" Font-Bold="true" Text="Total Employees"  />
                        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" style="width:300px;height:70px;background-color:green;font-size:medium;color:white" Font-Bold="true"  Text="Present"   />
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="width:300px;height:70px;background-color:red;font-size:medium;color:white" Font-Bold="true"  Text="Absent" />
                 </div>
            <br />
                    ...
                    <Columns>
                     ...
                     <%--    <asp:TemplateField HeaderText="Client Name" HeaderStyle-ForeColor="White">
                         ...
                         <asp:TemplateField HeaderText="State" HeaderStyle-ForeColor="White">
                          ...
                          <asp:TemplateField HeaderText="SAP Code" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
                                <asp:Label ID="lblSAPcode" CssClass="cssLable" runat="server" Text='<%# Bind("[SAP]") %>'></asp:Label>
                            </ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="<%$ Resources:Resource,EmployeeName %>" HeaderStyle-ForeColor="White">
                        ...
                        <asp:TemplateField HeaderText="Designation" HeaderStyle-Width="300px"
                         ...
                         <asp:TemplateField HeaderText="E.Code" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Category" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
                                <asp:Label ID="lblCategory" CssClass="cssLable" runat="server" Text='<%# Bind("[Category]") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle  Width="300px" />
                            <ItemStyle Width="300px" />
                            <FooterStyle Width="300px" />
                            ...
                            FooterStyle-Width="300px" ItemStyle-Width="300px">
                            <ItemTemplate>
                                <asp:Label ID="lblStaus" CssClass="cssLable" runat="server" Text='<%# Bind("Status") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="<%$Resources:Resource,Date %>" HeaderStyle-Width="400px"
