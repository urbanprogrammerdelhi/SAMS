...
// ***********************************************************************
// <copyright file="YLMAttendanceNoshow.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_YLMAttendanceNoshow.
/// </summary>
public partial class Transactions_YLMAttendanceNoshow : BasePage
{
    #region Properties
    ...
    protected void FillRadGrid1()
    {
        ...
        {
            DataSet ds = objR.YlmNoShowReportGet(
