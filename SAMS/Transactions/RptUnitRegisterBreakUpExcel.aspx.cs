...
// ***********************************************************************
// <copyright file="RptUnitRegisterBreakUpExcel.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_RptUnitRegisterBreakUpExcel.
/// </summary>
public partial class Transactions_RptUnitRegisterBreakUpExcel : BasePage //System.Web.UI.Page
{
    /// <summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        strFileName = "Unit Register Breakup" + DateTime.Now.ToString("dd-MMM-yyyy") + ".xls";
        ...
        ds = objRoster.UnitRegisterBreakup(BaseCompanyCode, BaseLocationCode, strFromDate, strToDate);
        ...
        for (int i = 0; i < ds.Tables[1].Rows.Count; i++)
        {
            ...
            sb.Append("<td width='100px' colspan='25' >" + ds.Tables[1].Rows[i]["Post"].ToString() + " [" + ds.Tables[1].Rows[i]["Shift"].ToString().Trim() + "]</td>");
            ...
            //sb.Append("<td width='100px' colspan='15'>" + ds.Tables[1].Rows[i]["Shift"].ToString().Trim() + "</td>");
            //sb.Append("<td colspan='20'>&nbsp</td>");
            sb.Append("</tr>");
            sb.Append("</table>");
            ...
            dtPost = dv.ToTable();
            sb.Append("<table width='900'  border=1 cellspacing=0 cellpadding=0>");
            sb.Append("<tr>");
           ...
           // sb.Append("<td style='background-color:#C0C0C0; display:none;'>" + "Price Hours" + "</td>");
            ...
            for (int m = 0; m < ds.Tables[3].Rows.Count; m++)
            {
                sb.Append("<tr>");
                DataView dv1 = new DataView(dtPost);
                dv1.RowFilter = "[Hours_Type]='" + (ds.Tables[3].Rows[m]["Hours_Type"].ToString()) + "'";
                DataTable dtDay = new DataTable();
                dtDay = dv1.ToTable();
                double TotalHoursBasedOnType = 0.00;
                double rowWiseTotalHrs = 0.00;
                int y = 0;
                sb.Append("<td style='background-color:#C0C0C0;'>" + ds.Tables[3].Rows[m]["Hours_Type"].ToString() + "</td>");
                if (ds.Tables[2].Rows.Count != dtDay.Rows.Count && dtDay.Rows.Count > 0)
                {
                    ...
                    for (int z = y; y < ds.Tables[2].Rows.Count; z++)
                    {
                        try
                        {
                            ...
                            {
                                sb.Append("<td width=10px >" + dtDay.Rows[a]["Hours"].ToString() + "</td>");
