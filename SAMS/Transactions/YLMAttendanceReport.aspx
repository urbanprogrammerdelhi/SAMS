<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="YLMAttendanceReport.aspx.cs" Inherits="Transactions_YLMAttendanceReport" %>
        ...
        <Ajax:UpdatePanel runat="server" ID="up1" UpdateMode="Conditional">
            <ContentTemplate>
                    ...
                    <telerik:RadGrid id="RadGrid1"  Skin="Office2007"  runat="server" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="RadGrid1_ItemDataBound">
                        ...
                        <MasterTableView CssClass="RadGrid_MyCustomSkin" CommandItemDisplay="TopAndBottom" ShowHeadersWhenNoRecords="True" AutoGenerateColumns="False" AllowMultiColumnSorting="True" AllowSorting="True" 
                        AllowFilteringByColumn="True" PageSize="10" AllowPaging="True">
                          ...
                          <Columns>
                                 <telerik:GridTemplateColumn DataField="YLMUID" HeaderText="<%$ Resources:Resource, YLMUID %>" UniqueName="YLMUID" SortExpression="YLMUID">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblYLMUID" CssClass="cssLable" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ActualRosterProcessedYLMAutoID").ToString()%>'></asp:Label>
                                    </ItemTemplate>
                              ...
                              <telerik:GridTemplateColumn DataField="EmployeeNumber" HeaderText="<%$ Resources:Resource, EmployeeNumber %>" UniqueName="EmployeeNumber" SortExpression="EmployeeNumber">
                               ...
                               <telerik:GridTemplateColumn DataField="EmployeeName" HeaderText="<%$ Resources:Resource, EmployeeName %>" UniqueName="EmployeeName" SortExpression="EmployeeName">
                                ...
                                <telerik:GridTemplateColumn DataField="SchTimeFrom" HeaderText="<%$ Resources:Resource, SchTimeFrom %>" UniqueName="SchTimeFrom" SortExpression="SchTimeFrom">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSchTimeFrom" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("SchTimeFrom")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn DataField="SchTimeTo" HeaderText="<%$ Resources:Resource, SchTimeTo %>" UniqueName="SchTimeTo" SortExpression="SchTimeTo">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate> 
                                        <asp:Label ID="lblSchTimeTo" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("SchTimeTo")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>


                                 <telerik:GridTemplateColumn DataField="ActTimeFrom" HeaderText="<%$ Resources:Resource, ActTimeFrom %>" UniqueName="ActTimeFrom" SortExpression="ActTimeFrom">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:Label ID="lblActTimeFrom" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("ActTimeFrom")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn DataField="ActTimeTo" HeaderText="<%$ Resources:Resource, ActTimeTo %>" UniqueName="ActTimeTo" SortExpression="ActTimeTo">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate> 
                                        <asp:Label ID="lblActTimeTo" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("ActTimeTo")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>


                                 <telerik:GridTemplateColumn DataField="YLMProcessedTimeFrom" HeaderText="<%$ Resources:Resource, YLMProcessedTimeFrom %>" UniqueName="YLMProcessedTimeFrom" SortExpression="YLMProcessedTimeFrom">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:HiddenField runat="server" id="hfYLMProcessedTimeFrom" Value='<%# String.Format("{0:dd-MMM-yyyy}",Eval("YLMProcessedTimeFrom"))%>' />
                                        <asp:Label ID="lblYLMProcessedTimeFrom" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("YLMProcessedTimeFrom")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn DataField="YLMProcessedTimeTo" HeaderText="<%$ Resources:Resource, YLMProcessedTimeTo %>" UniqueName="YLMProcessedTimeTo" SortExpression="YLMProcessedTimeTo">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate> 
                                        <asp:HiddenField runat="server" id="hfYLMProcessedTimeTo" Value='<%# String.Format("{0:dd-MMM-yyyy}",Eval("YLMProcessedTimeTo"))%>' />
                                        <asp:Label ID="lblYLMProcessedTimeTo" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("YLMProcessedTimeTo")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>


                                  <telerik:GridTemplateColumn DataField="YLMRawTimeFrom" HeaderText="<%$ Resources:Resource, YLMRawTimeFrom %>" UniqueName="YLMRawTimeFrom" SortExpression="YLMRawTimeFrom">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:HiddenField runat="server" id="hfYLMRawTimeFrom" Value='<%# String.Format("{0:dd-MMM-yyyy}",Eval("YLMRawTimeFrom"))%>' />
                                        <asp:Label ID="lblYLMRawTimeFrom" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("YLMRawTimeFrom")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn DataField="YLMRawTimeTo" HeaderText="<%$ Resources:Resource, YLMRawTimeTo %>" UniqueName="YLMRawTimeTo" SortExpression="YLMRawTimeTo">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate> 
                                        <asp:HiddenField runat="server" id="hfYLMRawTimeTo" Value='<%# String.Format("{0:dd-MMM-yyyy}",Eval("YLMRawTimeTo"))%>' />
                                        <asp:Label ID="lblYLMRawTimeTo" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("YLMRawTimeTo")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
