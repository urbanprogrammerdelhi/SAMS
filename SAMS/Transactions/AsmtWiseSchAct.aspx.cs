...
// ***********************************************************************
// <copyright file="AsmtWiseSchAct.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_AsmtWiseSchAct.
/// </summary>
public partial class Transactions_AsmtWiseSchAct : BasePage
{
    #region Properties
    ...
    protected void FillRadGrid1()
    {
        ...
        {
            DataSet ds = objR.SchActualAsmtWiseGet(this.ReportParameters[DL.Properties.Resources.CompanyCode].ToString(),
