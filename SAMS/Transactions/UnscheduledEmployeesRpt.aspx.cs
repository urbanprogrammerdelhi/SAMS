...
// ***********************************************************************
// <copyright file="UnscheduledEmployeesRpt.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_UnscheduledEmployeesRpt.
/// </summary>
public partial class Transactions_UnscheduledEmployeesRpt : BasePage
{
    #region Properties
    ...
    protected void FillRadGrid1()
    {
        ...
        {
            DataSet ds = objR.UnscheduledEmployees(
                ...
                this.ReportParameters[DL.Properties.Resources.RosterOrSchedule].ToString(),
