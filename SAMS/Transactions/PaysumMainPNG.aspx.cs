...
// ***********************************************************************
// <copyright file="PaysumMainPNG.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_PaysumMainPNG.
/// </summary>
public partial class Transactions_PaysumMainPNG : BasePage//System.Web.UI.Page
{
    #region Properties
    ...
    {
        Response.Redirect("PaysumSubPNG.aspx?BusinessRuleCode=" + ddlBR.SelectedItem.Value.ToString() + "&PeriodNumber=" + ddlPeriodCollection.SelectedItem.Value.ToString() + "&BusinessRuleDesc=" + ddlBR.SelectedItem.Text.ToString() + "&PeriodDesc=" + ddlPeriodCollection.SelectedItem.Text.ToString());
