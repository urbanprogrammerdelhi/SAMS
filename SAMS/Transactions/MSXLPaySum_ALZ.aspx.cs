...
// ***********************************************************************
// <copyright file="MSXLPaySum_ALZ.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_MSXLPaySum_ALZ.
/// </summary>
public partial class Transactions_MSXLPaySum_ALZ : BasePage//System.Web.UI.Page
{
    #region Properties
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ds = objRoster.GeneratePaysumFlat(BaseCompanyCode, strDivision, strBranch, int.Parse(strMonth), int.Parse(strYear), BaseUserID);
        ...
        //        strWOOTHours = ds.Tables[0].Rows[i]["WOOTHours"].ToString();
        //    }
        //    NormalOTHours = NormalOTHours +(double.Parse(strDutyOT) + double.Parse(strWOOTHours));
        ...
        #region To Export Date In Excel Flat
        Response.Clear();
        Response.AddHeader("Content-Disposition", "attachment; filename=PaySum.xls");
        Response.ContentType = "application/octet-stream";
        Response.Write("<html>");
        ...
        Response.Write("</head>");
        Response.Write("<body>");
        Response.Write("<table width=200 cellspacing=0 cellpadding=0>");
        Response.Write("<tr>");
        // To Show Day Name**********************
