...
// ***********************************************************************
// <copyright file="YLMRawDataRpt.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_YLMRawDataRpt.
/// </summary>
public partial class Transactions_YLMRawDataRpt : BasePage
{
    #region Properties
    ...
    protected void FillRadGrid1()
    {
        ...
        {
            DataSet ds = objR.YlmRawDataReportGet(
