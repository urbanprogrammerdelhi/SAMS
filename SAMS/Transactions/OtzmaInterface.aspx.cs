...
// ***********************************************************************
// <copyright file="OtzmaInterface.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_OtzmaInterface.
/// </summary>
public partial class Transactions_OtzmaInterface : BasePage
{
    ...
    protected void btnProceed_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strJobName = System.Configuration.ConfigurationManager.AppSettings["JobExecution"];
            DL.ConnectionString con = new DL.ConnectionString();
           // string strConnectionString= con.GetConnectionString();
            string connect = con.GetConnectionString();
            using (SqlConnection oConnection = new SqlConnection(connect))
            {
                ...
                lblMessage.Text = "Upload in progress its take 5 to 10 Min Once upload is completed You will recevied Otzma Log  mail ";
            }
        }
        catch (Exception ex)
        {
