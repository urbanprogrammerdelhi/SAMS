...
public partial class Transactions_EmployeeMultipleDuty : BasePage
{
    #region Properties
    ...
    private void FillgvActual()
    {
        ...
        int dtflag;
        dtflag = 1;
        ds = objSales.EmployeeMultipleDutyDashboardGet(ddlClientCode.SelectedItem.Value, ddlAsmtId.SelectedItem.Value, ddlShift.SelectedItem.Value, txtDutyDate.Text);
        dt = ds.Tables[0];
