<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="RptGroup_Attendence_Aus.aspx.cs" Inherits="Transactions_RptGroup_Attendence_Aus"
        ...
        <tr>
            <td align="center" style="width: 100%">
                <asp:Panel ID="PanelReportType" Width="700px" Height="420px" GroupingText="<%$Resources:Resource,Rostering %>"
                    ...
                    <asp:Panel ID="PanelElement" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="Label100" runat="server" Text="<%$Resources:Resource,Element %>" CssClass="cssLable"></asp:Label>
                                </td>
                                <td align="left" colspan="4">
                                    <uc1:MultipleSelection ID="msddlelement" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                        ...
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    ...
                                    OnSelectedIndexChanged="ddlAsmtCode_SelectedIndexChanged" Width="350px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlOption" Width="350" CssClass="cssDropDown" runat="server">
                                                <asp:ListItem Value="Scheduled" Text="<%$ Resources:Resource, Schedule %>"></asp:ListItem>
