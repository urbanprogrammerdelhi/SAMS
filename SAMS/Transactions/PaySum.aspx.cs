...
// ***********************************************************************
// <copyright file="PaySum.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_PaySum.
/// </summary>
public partial class Transactions_PaySum : BasePage//System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txtEndDate.Text = LastDateOfCurrentMonth_Get();
            FillddlClient();
        }
    }
    /// <summary>
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("MSXLPaySum.aspx?strClientCode=" + ddlClientCode.SelectedValue.ToString() + "&strFromDate=" + DateTime.Parse(txtStartDate.Text) + "&strToDate=" + DateTime.Parse(txtEndDate.Text));
    }
