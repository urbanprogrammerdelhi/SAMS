<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="YLMAttendanceNoshow.aspx.cs" Inherits="Transactions_YLMAttendanceNoshow" %>
                        ...
                        AllowFilteringByColumn="True" PageSize="10" AllowPaging="True">
                          ...
                          <Columns>
                              ...
                              <telerik:GridTemplateColumn DataField="EmployeeNumber" HeaderText="<%$ Resources:Resource, EmployeeNumber %>" UniqueName="EmployeeNumber" SortExpression="EmployeeNumber">
                               ...
                               <telerik:GridTemplateColumn DataField="SchTimeFrom" HeaderText="<%$ Resources:Resource, CallTime %>" UniqueName="CallTime" SortExpression="CallTime">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:Label ID="lblYLMTime" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("ActTimeIn")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
