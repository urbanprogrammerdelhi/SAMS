...
// ***********************************************************************
// <copyright file="scheduleAuthorize.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_scheduleAuthorize.
/// </summary>
public partial class Transactions_scheduleAuthorize : BasePage //System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //{
            //    lblPageHdrTitle.Text = Resources.Resource.ScheduleAuth;
            //}
            ...
            javaScript.Append("{\n");
            javaScript.Append("PageTitle('" + Resources.Resource.ScheduleAuth + "');");
            javaScript.Append("};\n");
            javaScript.Append("// -->\n");
            ...
            ///Resources.Resource.ScheduleAuth   
    ...
    protected void btnAuthorize_Click(object sender, EventArgs e)
    {
        ...
        ds = objRost.ScheduleAuthorize(int.Parse(BaseLocationAutoID), int.Parse(ddlMonth.SelectedValue.ToString()), int.Parse(txtYear.Text.ToString()), "Month", BaseUserID.ToString());
