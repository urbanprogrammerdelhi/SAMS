...
// Description      :Page Calls the KPI-MML report in SSRS.
// ***********************************************************************
// <copyright file="KPI_MML.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_KPI_MML.
/// </summary>
public partial class Transactions_KPI_MML : BasePage
{
    #region Properties
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        ...
        if (ValidateControles("KPI-MML"))
        {
            string strReportPagePath = "../Transactions/";
            Context.Items.Add("cxtReportFileName", "KPI-MML");
            ...
            Context.Items.Add("cxtReportName", "KPI-MML");
            ...
            Context.Items["cxtReturnPage"] = "../Transactions/KPI_MML.aspx";
    ...
    /// <summary>
    /// Handles the CheckedChanged event of the chkDefaultScreen control.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
    protected void chkDefaultScreen_CheckedChanged(object sender, EventArgs e)
    {
        CheckBox chk = sender as CheckBox;
        if (!chk.Checked)
        {
            chkNewScreen.Checked = true;
            btnViewReport.Attributes.Add("OnClientClick", "document.forms[0].target =_blank ;");
        }
        else
        {
            chkNewScreen.Checked = false;

            //chkDefaultScreen.Checked = true;
        }

        //if (chkDefaultScreen.Checked == true)
        //{
        //    chkNewScreen.Checked = false;
        //    chkDefaultScreen.Checked = true ;
        //}
        ...
        //{
        //    chkNewScreen.Checked = true;
        //    chkDefaultScreen.Checked = false;
        //}
    }
    /// <summary>
    /// Handles the CheckedChanged event of the chkNewScreen control.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
    protected void chkNewScreen_CheckedChanged(object sender, EventArgs e)
    {
        if (chkNewScreen.Checked == true)
        {
            chkNewScreen.Checked = true;
