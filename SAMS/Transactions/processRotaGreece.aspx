<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="processRotaGreece.aspx.cs" Inherits="Transactions_processRotaGreece"
...
--%>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                        <td align="right">
                                                <asp:Label Style="width: 200px" CssClass="cssLable" ID="Label1" runat="server"
                                                    Text="<%$ Resources:Resource,Process%>" Enabled="false"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:DropDownList ID="ddlProcess" runat="server" CssClass="cssDropDown" Width="80"
                                                    AutoPostBack="true" >
                                                    <asp:ListItem Text="<%$ Resources:Resource,Actual%>" Value="Actual"></asp:ListItem>
                                                    <asp:ListItem Text="<%$ Resources:Resource,Schedule%>" Value="Schedule"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" style="width: 200px">
                                                <asp:Label ID="lblEmployee" runat="server" Text="<%$Resources:Resource,Employee %> "
                                                    CssClass="cssLable"></asp:Label>
                                            </td>
                                            <td align="left" colspan="3">
                                                <cc1:DropCheck ID="ddlEmployees" runat="server" ValidationGroup="VgEmployee" CssClass="cssDropDown"
                                                    AutoPostBack="false" OnSelectedIndexChanged="ddlEmployees_SelectedIndexChanged"
                                                    Width="350px">
                                                </cc1:DropCheck>
                                            </td>
                                        </tr>
