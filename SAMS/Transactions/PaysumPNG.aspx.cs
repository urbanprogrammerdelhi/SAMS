...
// ***********************************************************************
// <copyright file="PaysumPNG.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_PaysumPNG.
/// </summary>
public partial class Transactions_PaysumPNG : BasePage
{
    #region Properties
    ...
    protected void FillDataGrid()
    {
        ...
        ds = objRoster.GeneratePaysumPng(BaseCompanyCode, BaseHrLocationCode, BaseLocationCode, TxtFDate.Text, TxtTDate.Text);
