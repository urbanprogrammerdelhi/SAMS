<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="PaysumMainPNG.aspx.cs" Inherits="Transactions_PaysumMainPNG" %>
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td colspan="4">
                                    <asp:Label ID="lblPageHeading" runat="server" CssClass="cssLabelHeader" Text="Payment Summary PNG"></asp:Label>
                                    <br />
                                    <br />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <asp:Button ID="btnProceed" runat="server" CssClass="cssButton" Text="View" OnClick="btnProceed_Click" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnGeneratePaysum" Visible="false" runat="server" CssClass="cssButton" Text="Generate Paysum"
                                        OnClick="btnGeneratePaysum_Click" />
                                    &nbsp;
                                    <asp:LinkButton ID="btnFinalPaysum" Visible="false" runat="server" CssClass="csslnkButton" Text="Send Paysum to Payroll"
