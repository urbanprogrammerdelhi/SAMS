<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="ScheduleControlReport.aspx.cs" Inherits="Transactions_ScheduleControlReport" %>
    ...
    <table>
        <tr>
            <td>
                ...
                <asp:Panel runat="server" ID="PnlReport" GroupingText= "<%$ Resources:Resource, ScheduleControlReport %>" Height="100%" Width="100%">
                    ...
                    <telerik:RadGrid ID="RadGrid1" GridLines="Both" Width="2000px" Skin="Office2007"
                        runat="server" OnNeedDataSource="RadGrid1_NeedDataSource"  OnPreRender="RadGrid1_PreRender" OnItemDataBound="RadGrid1_ItemDataBound"
                        AllowPaging="true">
                        ...
                        <MasterTableView Name="DomainLabel" CssClass="RadGrid_MyCustomSkin" CommandItemDisplay="TopAndBottom"
