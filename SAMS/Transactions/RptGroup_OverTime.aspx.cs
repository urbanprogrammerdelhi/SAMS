...
// ***********************************************************************
// <copyright file="RptGroup_OverTime.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_RptGroup_OverTime.
/// </summary>
public partial class Transactions_RptGroup_OverTime : BasePage
{
    #region Properties
    ...
    private void HideAllControles()
    {
        ...
        PanelWeekStartDate.Visible = false;
    }
    #endregion
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        if (ValidateControles(ddlReportName.SelectedItem.Value.ToString()))
        {
            ...
            Context.Items["cxtReturnPage"] = "../Transactions/RptGroup_OverTime.aspx?ReportName=" + ddlReportName.SelectedItem.Value.ToString();
    ...
    private Hashtable ReportParameter_Get(string strReportName)
    {
        ...
        switch (strReportName)
        {
            ...
            case "OverTimeReportBarbados.rpt":
                ...
                hshRptParameters.Add(DL.Properties.Resources.FromDate, DL.Common.DateFormat(txtFromDate.Text.ToString(), ""));
                hshRptParameters.Add(DL.Properties.Resources.ToDate, DL.Common.DateFormat(txtToDate.Text.ToString(), ""));
                hshRptParameters.Add(DL.Properties.Resources.ModifiedBy, BaseUserName);
                return hshRptParameters;
            case "ProjectedOTDetails.rpt":
                hshRptParameters.Add(DL.Properties.Resources.LocationAutoId, BaseLocationAutoID);
                hshRptParameters.Add(DL.Properties.Resources.Month, int.Parse(ddlMonth.SelectedValue));
                hshRptParameters.Add(DL.Properties.Resources.Year, int.Parse(txtYear.Text));
                hshRptParameters.Add(DL.Properties.Resources.type, ddlType.SelectedValue);
                hshRptParameters.Add(DL.Properties.Resources.NegariveProjOT, ChkNegative.Checked.ToString());
                hshRptParameters.Add(DL.Properties.Resources.RostType, ddlSchAct.SelectedValue);
                hshRptParameters.Add(DL.Properties.Resources.WithOutZeroAttendance, ChkWithOutZeroAttendance.Checked.ToString());
                if (ddlType.SelectedItem.Value.ToString() == "Summary")
                {
                    Context.Items["cxtReportFileName"] = "ProjectedOTSummary.rpt";
                }
