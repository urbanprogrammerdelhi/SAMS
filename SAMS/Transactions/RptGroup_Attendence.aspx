<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="RptGroup_Attendence.aspx.cs" Inherits="Transactions_RptGroup_Attendence"
        ...
        <tr>
            <td align="center" style="width: 100%">
                <asp:Panel ID="PanelReportType" Width="700px" Height="420px" GroupingText="<%$Resources:Resource,Rostering %>"
                    ...
                    <asp:Panel ID="PanelLocation" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    <asp:DropDownList ID="ddlDivision" AutoPostBack="true" runat="server" CssClass="cssDropDown" Enabled="False"
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="4">
                                    <asp:DropDownList ID="ddlBranch" AutoPostBack="false" runat="server" CssClass="cssDropDown" Enabled="False"
                                        Width="350px">
                                    </asp:DropDownList>
                                    <uc1:MultipleSelection ID="msddlBranch" CssClass="cssDropDown" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PanelEmployeePaidOnlyAll" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="Label15" runat="server" Text="<%$Resources:Resource,PaidOnlyOrAll %> "
                                        CssClass="cssLable"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <Ajax:UpdatePanel runat="server" ID="UPEmployeePaidOnlyAll" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlEmployeePaidOnlyAll" runat="server" CssClass="cssDropDown" Width="328">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </Ajax:UpdatePanel>
                                </td>
                    ...
                    <%-- <asp:Panel ID="PanelEmployee1" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="Label15" runat="server" Text="<%$Resources:Resource,EmployeeNumber %> "
                                        CssClass="cssLable"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <Ajax:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlEmployeeNumber1" runat="server" CssClass="cssDropDown" Width="328">
                                            </asp:DropDownList>
                                            <asp:ImageButton ID="ImgBtnEmployees1" runat="server" ToolTip="Refresh Employees"
                                                ImageUrl="~/Images/Reset.gif" OnClick="RefreshEmpList_Click" />
                                        </ContentTemplate>
                                    </Ajax:UpdatePanel>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    <asp:RadioButton ID="rdoAssigmentWise" Checked="true" GroupName="G1" runat="server"
                                        ...
                                        oncheckedchanged="rdoAssigmentWise_CheckedChanged" AutoPostBack="true"  />
                                    <asp:RadioButton ID="rdoPostWise" GroupName="G1" runat="server" 
                                        Text="<%$Resources:Resource,PostWise %>" 
                                        oncheckedchanged="rdoPostWise_CheckedChanged" AutoPostBack="true" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                   ...
                   <%-- ----------------Add New Dropdown SoType SAT214----------------------------%>

                       <asp:Panel ID="pnlSoType" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="lblSoType" runat="server" Text="<%$Resources:Resource,SOType %>" CssClass="cssLable"></asp:Label>
                                </td>
                                <td align="left">
                                   <asp:DropDownList CssClass="cssDropDown" ID="ddlSoType" runat="server"/>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                   ...
                   <%-- ------------------------END ----------------------------------------------%>
                   <%----------------------------- Added New Panel for SAT1191 Deployment Detail Report ----------------------%>
                   <asp:Panel ID="pnlDeploymentDetailType" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                </td>
                                <td align="left" colspan="3">
                                    <asp:RadioButton ID="rdbEmployeeWise" Checked="true" GroupName="G1" runat="server"
                                        Text="<%$Resources:Resource,EmployeeWise %>" />
                                    <asp:RadioButton ID="rdbCustomerWise" GroupName="G1" runat="server" 
                                        Text="<%$Resources:Resource,CustomerWise %>" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    <asp:DropDownList ID="ddlReportStatus" Width="350" runat="server" CssClass="cssDropDown">
                                        <asp:ListItem Value="Summary" Text="<%$Resources:Resource,Summary %>"></asp:ListItem>
