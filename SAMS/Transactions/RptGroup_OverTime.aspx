<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="RptGroup_OverTime.aspx.cs" Inherits="Transactions_RptGroup_OverTime"
        ...
        <tr>
            <td align="center" style="width: 100%">
                <asp:Panel ID="PanelReportType" Width="600px" GroupingText="<%$Resources:Resource,OTReport %>"
                    ...
                    <asp:Panel ID="PanelddlSchAct" Width="800px" BorderWidth="0px" runat="server">
                        ...
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                ...
                                <td align="left" colspan="3">
                                    <asp:CheckBox ID="ChkWithOutZeroAttendance" runat="server" CssClass="cssCheckBox" Width="200px"
                                        Checked="false" Text="<%$ Resources:Resource,WithOutZeroAttendance %>" Height="20"></asp:CheckBox>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>       
                    ...
                    <asp:Panel ID="PanelWeekStartDate" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="LabelWeekStartDate" runat="server" Text="<%$Resources:Resource,FromDate %>" CssClass="cssLable"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <asp:TextBox CssClass="csstxtboxSmall" Text="" ID="txtWeekStartDate" runat="server" AutoPostBack="false"></asp:TextBox>
                                    <asp:HyperLink ID="ImgWeekStartDate" Style="vertical-align: middle;" runat="server" ImageUrl="~/Images/pdate.gif"></asp:HyperLink>
                                    <AjaxToolKit:CalendarExtender ID="CalendarExtenderWeekStartDate" Format="dd-MMM-yyyy" runat="server"
                                        TargetControlID="txtWeekStartDate" PopupButtonID="ImgWeekStartDate">
                                    </AjaxToolKit:CalendarExtender>
                                </td>
                            </tr>
                        </table>
