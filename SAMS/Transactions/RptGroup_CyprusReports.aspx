<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="RptGroup_CyprusReports.aspx.cs" Inherits="Transactions_RptGroup_CyprusReports" Title="<%$ Resources:Resource, AppTitle %>" %>
    ...
    <table width="80%" border="0" cellpadding="1" cellspacing="0">
        <tr>
            <td align="center" style="width: 100%">
                <asp:Panel ID="PanelReportType" Width="810px" GroupingText="<%$Resources:Resource,PostingSheet %>"
