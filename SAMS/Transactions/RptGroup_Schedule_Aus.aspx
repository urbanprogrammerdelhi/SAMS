<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="RptGroup_Schedule_Aus.aspx.cs" Inherits="Sales_RptGroup_Schedule_Aus" Title="<%$ Resources:Resource, AppTitle %>" %>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlRptType" CssClass="cssDropDown" Style="width: 300px;" runat="server">
                                                ...
                                                <asp:ListItem Text="<%$Resources:Resource,Actual %>" Value="Dep"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <asp:Panel ID="pnlShiftType" Width="800px" BorderWidth="0px" runat="server">
                                <table width="800px" border="0" cellpadding="1" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlShiftType" Width="135px" runat="server" CssClass="cssDropDown">
