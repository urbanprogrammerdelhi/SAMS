...
// ***********************************************************************
// <copyright file="getSitePostEmployeePostAjax.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_getSitePostEmployeePostAjax.
/// </summary>
public partial class Transactions_getSitePostEmployeePostAjax : BasePage
{
    #region Properties
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //blAsmtSiteEmployeePost_Get
        BL.OperationManagement objOperationManagement = new BL.OperationManagement();
        DataSet dsAsmtSitePost = new DataSet();
        dsAsmtSitePost = objOperationManagement.AsmtSiteEmployeePostGet(intAsmtId, int.Parse(BaseLocationAutoID), strFromDate, strToDate);
