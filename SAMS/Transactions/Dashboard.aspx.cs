...
/// <summary>
/// Class Transactions_Dashboard.
/// </summary>
public partial class Transactions_Dashboard : BasePage
{
     #region Properties
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        ...
        if (ValidateControles("Dashboard"))
        {
            string strReportPagePath = "../Transactions/";
            Context.Items.Add("cxtReportFileName", "Dashboard");
            ...
            Context.Items.Add("cxtReportName", "Dashboard");
            ...
            Context.Items["cxtReturnPage"] = "../Transactions/Dashboard.aspx";
