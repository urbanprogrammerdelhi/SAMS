<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="scheduleAuthorize.aspx.cs" Inherits="Transactions_scheduleAuthorize"
                            ...
                            <div class="squarebox">
                                <div class="squareboxgradientcaption" style="height: 15px; cursor: pointer;" ">
                                    <div style="float: left; width: 670px;">
                                        <tt style="text-align: center;">
                                            <asp:Label ID="Label5" CssClass="squareboxgradientcaption" runat="server" Text="<%$ Resources:Resource, ScheduleAuth %>" ></asp:Label></tt></div>
                                </div>
                                <div class="squareboxcontent">
                                    <table border="0" cellpadding="3" cellspacing="0" style="width: 700px">
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label Style="width: 100px" CssClass="cssLable" ID="Label1" runat="server" Text="<%$ Resources:Resource, Month %>" ></asp:Label>
                                            </td>
                                            <td align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Button ID="btnAuthorize" runat="server" CssClass="cssButton" Text="<%$ Resources:Resource, Authorize %>" 
                                                    ValidationGroup="vg1" OnClick="btnAuthorize_Click" />
                                            </td>
                                        </tr>
                                        <tr>
