<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="IndReports.aspx.cs" Inherits="Transactions_IndReports" Title="<%$ Resources:Resource, AppTitle %>" %>
        ...
        <tr>
            <td align="center" style="width: 100%">
                <asp:Panel ID="PanelReportType" Width="700px" Height="420px" GroupingText="<%$Resources:Resource,Rostering %>"
                    ...
                    <asp:Panel ID="PanelDutyPerform" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="lblNHours" runat="server" CssClass="cssLabel" Text="<%$Resources:Resource,NHours %>"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <asp:TextBox Width="30%" MaxLength="4" CssClass="csstxtboxSmall" ID="txtNHours" runat="server" Text=""
                                        AutoPostBack="false"  > </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="lblContDays" runat="server" CssClass="cssLabel" Text="<%$Resources:Resource,ContinuityDays %>"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <asp:TextBox Width="30%" MaxLength="4" CssClass="csstxtboxSmall" ID="txtContDays" runat="server" Text=""
                                        AutoPostBack="false"  > </asp:TextBox>
                                </td>
                            </tr>
                        </table>
                     ...
                     <asp:Panel ID="PanelFromToHours" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="lblFromHours" runat="server" CssClass="cssLabel" Text="<%$Resources:Resource,FromHours %>"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <asp:TextBox Width="30%" MaxLength="4" CssClass="csstxtboxSmall" ID="txtFromHours" runat="server" Text=""
                                        AutoPostBack="false"  > </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="lblToHours" runat="server" CssClass="cssLabel" Text="<%$Resources:Resource,ToHours %>"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <asp:TextBox Width="30%" MaxLength="4" CssClass="csstxtboxSmall" ID="txtToHours" runat="server" Text=""
                                        AutoPostBack="false"  > </asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    ...
                    <asp:Panel ID="PanelCheckBox" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:CheckBox ID="chkAbsent" runat="server" Checked="true" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="width: 200px">
                                ...
                                <td align="left">
                                    <asp:CheckBox ID="chkLeave" runat="server" Checked="true" />
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="width: 200px">
                                ...
                                <td align="left">
                                    <asp:CheckBox ID="chkWeekOff" runat="server" Checked="true" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="PanelDutyType" Width="800px" BorderWidth="0px" runat="server">
                        <table width="800px" border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="right" style="width: 200px">
                                    <asp:Label ID="lblDutyType" runat="server" CssClass="cssLabel" Text="<%$Resources:Resource,DutyType %>"></asp:Label>
                                </td>
                                <td align="left" colspan="3">
                                    <asp:DropDownList ID="ddlDutyType" runat="server" CssClass="cssDropDown" AutoPostBack="false"
                                        Width="150px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
