<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="YLMAttendanceVacantPost.aspx.cs" Inherits="Transactions_YLMAttendanceVacantPost" %>
                          ...
                          <Columns>
                              ...
                              <telerik:GridTemplateColumn DataField="EmployeeNumber" HeaderText="<%$ Resources:Resource, EmployeeNumber %>" UniqueName="EmployeeNumber" SortExpression="EmployeeNumber">
                               ...
                               <telerik:GridTemplateColumn DataField="EmployeeName" HeaderText="<%$ Resources:Resource, EmployeeName %>" UniqueName="EmployeeName" SortExpression="EmployeeName">
                                ...
                                <telerik:GridTemplateColumn DataField="SchTimeFrom" HeaderText="<%$ Resources:Resource, TimeFrom %>" UniqueName="SchTimeFrom" SortExpression="SchTimeFrom">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSchTimeFrom" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("TimeFrom")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn DataField="SchTimeTo" HeaderText="<%$ Resources:Resource, Timeto %>" UniqueName="SchTimeTo" SortExpression="SchTimeTo">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSchTimeTo" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("Timeto")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                               <telerik:GridTemplateColumn DataField="OutCallTime" HeaderText="<%$ Resources:Resource, OutCallTime %>" UniqueName="OutCallTime" SortExpression="OutCallTime">
                                    <HeaderStyle Width="100px"/>
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:Label ID="lblYLMTime" CssClass="cssLable" runat="server" Text='<%# String.Format("{0:H:mm}",Eval("ActTimeOut")) %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                             ...
                             <telerik:GridTemplateColumn DataField="YLMUID" HeaderText="<%$ Resources:Resource, YLMUID %>" UniqueName="YLMUID" SortExpression="YLMUID">
                                    ...
                                    <ItemStyle Width="100px" VerticalAlign="Top"/>
                                    <ItemTemplate>
                                        <asp:Label ID="lblShiftCode" CssClass="cssLable" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SaleOrderDeptShiftUID").ToString()%>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
