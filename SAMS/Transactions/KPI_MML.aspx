<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="KPI_MML.aspx.cs" Inherits="Transactions_KPI_MML" %>
                            ...
                            <table width="650px" border="0" cellpadding="1" cellspacing="0">
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <telerik:RadComboBox ID="ddlCompany" runat="server" Width="250px" MaxHeight="350px"
                                            CheckedItemsTexts="DisplayAllInInput" AllowCustomText="true" NoWrap="true" Filter="StartsWith"
                                            EmptyMessage="Please Select" OnSelectedIndexChanged="ddlCompany_SelectedIndexChanged"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <telerik:RadComboBox ID="ddlHrLocation" runat="server" Width="250px" MaxHeight="350px" AllowCustomText="true"
                                            NoWrap="true" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Filter="StartsWith"
                                            CheckedItemsTexts="DisplayAllInInput" EmptyMessage="Please Select" OnSelectedIndexChanged="ddlHrLocation_SelectedIndexChanged"
                                            AutoPostBack="true" CausesValidation="false">
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <telerik:RadComboBox ID="ddlLocation" runat="server" Width="250px" MaxHeight="350px"    
                                            AllowCustomText="true" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" AutoPostBack="true"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div style="width: 80px;">
                                            <%--Due to IE problem we have done this fix--%>
                                ...
                                <%--Code modified for hidding Row-- Task 731 --%>
