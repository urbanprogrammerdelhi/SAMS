...
// ***********************************************************************
// <copyright file="Actual_Schedule_Comparison_Egypt.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_Actual_Schedule_Comparison_Egypt.
/// </summary>
public partial class Transactions_Actual_Schedule_Comparison_Egypt : BasePage
{
    #region Properties
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //{ lblPageHdrTitle.Text = Resources.Resource.ScheduleClientCode; }
            ...
            javaScript.Append("{\n");
            javaScript.Append("PageTitle('" + Resources.Resource.ScheduleClientCode + "');");
            javaScript.Append("};\n");
            javaScript.Append("// -->\n");
    ...
    protected void FillDataGrid()
    {
        ...
        ds = objRoster.ActualAndScheduleComparison(BaseCompanyCode, BaseHrLocationCode, BaseLocationCode, TxtFDate.Text, TxtTDate.Text, BaseUserID);
    ...
    /// <summary>
    /// Handles the OnClick event of the btnProcessData control.
    /// </summary>
    /// <param name="sender">The source of the event.</param>
    /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
    protected void btnProcessData_OnClick(object sender, EventArgs e)
    {
        FillDataGrid();
