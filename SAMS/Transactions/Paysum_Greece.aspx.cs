...
// ***********************************************************************
// <copyright file="Paysum_Greece.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Transactions_PaySum_Greece.
/// </summary>
public partial class Transactions_PaySum_Greece : BasePage
{
    ...
    protected void FillDataGrid()
    {
        ...
        ds = objRoster.GeneratePaysumGreece(BaseCompanyCode, BaseHrLocationCode, BaseLocationCode, TxtFDate.Text, TxtTDate.Text, BaseUserID,"1");
