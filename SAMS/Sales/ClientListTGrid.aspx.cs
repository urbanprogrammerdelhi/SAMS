...
// ***********************************************************************
// <copyright file="ClientListTGrid.aspx.cs" company="Magnon">
...
/// <summary>
/// Class Sales_ClientListTGrid.
/// </summary>
public partial class Sales_ClientListTGrid : BasePage
{
    #region Properties
    ...
    {
        var objR = new BL.Sales();
        //if (ReportParameters != null)
        //{
            DataSet ds = objR.ClientListGet(BaseCompanyCode, BaseUserIsAreaIncharge, BaseUserID);
