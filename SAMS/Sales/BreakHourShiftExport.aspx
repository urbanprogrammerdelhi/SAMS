...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="BreakHourShiftExport.aspx.cs" Inherits="BreakHour_Export" %>
        ...
        <tr>
            <td>
               <%-- <div style="text-align: right;">
                ...
                <asp:Panel runat="server" ID="PnlReport"  Height="100%" Width="100%">
                    ...
                    <telerik:RadGrid ID="RadGrid1" GridLines="Both" Width="2000px" Skin="Office2007"
                        runat="server" OnNeedDataSource="RadGrid1NeedDataSource" OnItemDataBound="RadGrid1ItemDataBound"
                        AllowPaging="true">
