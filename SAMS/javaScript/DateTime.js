...
// Month        |  (name or abbr.)| MM (2 digits), M (1 or 2 digits)
//              | NNN (abbr.)        |
...
// Examples:
//  " d, y" matches: January 01, 2000
//                      Dec 1, 1900
//                      Nov 20, 00
//  "M/d/yy"   matches: 01/20/00
//                      9/2/00
//  " dd, yyyy hh:mm:ssa" matches: "January 01, 2000 12:30:45AM"
// ------------------------------------------------------------------
...
// ------------------------------------------------------------------
// DateAdd ( Date  , Interval, Increment )
// Returns the date after adding or substracting the Interval and increment value in the date
...
// -------------------------------------------------------------------
function compareTwoDates(date1,dateformat1,date2,dateformat2) 
{    
...
function getDateFromFormat(val,format) {
	...
	while (i_format < format.length) {
		...
		else if (token==""||token=="NNN"){
			month=0;
			for (var i=0; i<MONTH_NAMES.length; i++) {
				var month_name=MONTH_NAMES[i];
				if (val.substring(i_val,i_val+month_name.length).toLowerCase()==month_name.toLowerCase()) {
					if (token==""||(token=="NNN"&&i>11)) {
						month=i+1;
...
// y-M-d    d, y    d,y   y--d   d--y   d
// M/d/y   M-d-y      M.d.y     -d     M/d      M-d
// d/M/y   d-M-y      d.M.y     d-     d/M      d-M
...
function parseDate(val) {
	...
	generalFormats=new Array('y-M-d',' d, y',' d,y','y--d','d--y',' d');
	monthFirst=new Array('M/d/y','M-d-y','M.d.y','-d','M/d','M-d');
	dateFirst =new Array('d/M/y','d-M-y','d.M.y','d-','d/M','d-M');
...
function DateValidation(ID,MonthId,YearId)
       {
            ...
            var leapYear = parseInt(document.getElementById(MonthId).value)%4;
            var currentMonth = document.getElementById(YearId).value.toUpperCase();
            ...
            {
                document.getElementById(ID).value = strDate + "-" + document.getElementById(MonthId).value +"-"+document.getElementById(YearId).value;
            }
            else
            {
                    ...
                    for (var i=1; i<= strDate.length; i++)
	                {
		                    ...
		                    if(strDate.charAt(i)=="-")
		                    {
		                            ...
		                            if(varmonth.toUpperCase()=="JAN" || varmonth.toUpperCase()=="FEB" || varmonth.toUpperCase()=="MAR" || varmonth.toUpperCase()=="APR" || varmonth.toUpperCase()=="MAY" || varmonth.toUpperCase()=="JUN" || varmonth.toUpperCase()=="JUL" || varmonth.toUpperCase()=="AUG" || varmonth.toUpperCase()=="SEP" || varmonth=="Oct" || varmonth.toUpperCase()=="NOV" || varmonth.toUpperCase()=="DEC" )
		                            {
		                                ...
		                                document.getElementById(MonthId).value = varmonth;
		                                i = i+4;
		                                while(i < strDate.length)
		                                {
		                                    if(strDate.charAt(i)=="-")
		                                        {
		                                            document.getElementById(YearId).value = strDate.substring(i+1, i+5);;
		                                            i = strDate.length;
		                                        }
		                                i=i+1;
		                                }
