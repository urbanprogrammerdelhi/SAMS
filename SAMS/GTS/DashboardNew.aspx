<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardNew.aspx.cs" Inherits="GTS_DashboardNew" %>
...
<body>
                ...
                <table align="center" width="100%" border="0" cellspacing="1px" cellpadding="1px" style="height:150px" >
                    ...
                    <tr style="background-color: #D3E8F4">
                        ...
                        <td style="text-align: left;" class="auto-style5">
                            <asp:TextBox ID="txtFromDate" CssClass="csstxtbox" runat="server" Width="80px" OnTextChanged="txtFromDate_TextChanged" AutoPostBack="true"></asp:TextBox>
                        ...
                        <td style="text-align: left;" class="auto-style5">
                            <asp:TextBox ID="txtDutyDate" CssClass="csstxtbox" runat="server" Width="80px" OnTextChanged="txtDutyDate_TextChanged" AutoPostBack="true"></asp:TextBox>
    ...
    <Style SelectBoxWidth="250" DropDownBoxBoxWidth="250" DropDownBoxBoxHeight="52" />
   
</asp:DropDownCheckBoxes>
                            &nbsp;
<asp:ExtendedRequiredFieldValidator ID="ExtendedRequiredFieldValidator1" runat="server"
    ControlToValidate="ddltour" ErrorMessage="Required" ForeColor="Red">
