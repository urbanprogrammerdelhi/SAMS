...
public partial class GTS_Dashboard : BasePage
{
    static int flag;
    ...
    protected void FillgvAttendence()
    {
        ...
        var dtflag = 1;
        ds = objAssetMgmt.GetGTSReport(BaseLocationAutoID, txtFromDate.Text.Trim(), txtDutyDate.Text.Trim(), txtEmployeeNo.Text.Trim(), TourCode.ToString());
        dt = ds.Tables[0];
