...
public partial class GroupL_ShortageReport : BasePage
{
    static int flag;
    static int flagData;
    #region Properties
    ...
    protected void FillgvAttendence()
    {
        ...
        var dtflag = 1;
        ds = objAssetMgmt.GetShortageReport(txtDutyDate.Text.Trim(), BaseCompanyCode,ddlregion.SelectedItem.Value, ddlbranch.SelectedItem.Value,ddlemployee.SelectedItem.Value);
        if (flagData == 2)
        {
            btnAll.Text = "Total Employees - " + ds.Tables[1].Rows[0]["TotalEmp"].ToString();
            Button2.Text = "Total Present - " + ds.Tables[3].Rows[0]["Present"].ToString();
            Button1.Text = "Total Absent - " + ds.Tables[2].Rows[0]["Absent"].ToString();
        }
        dt = ds.Tables[0];
        if (dt.Rows.Count == 0)
        {
    ...
    protected void gvAttendence_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblbranchnamecma = (Label)e.Row.FindControl("lblbranchnamecma");
            lblbranchnamecma.ForeColor = System.Drawing.Color.Black;
            lblbranchnamecma.Font.Bold = true;
            ...
            Label lblbranchnameregion = (Label)e.Row.FindControl("lblbranchnameregion");
            lblbranchnameregion.ForeColor = System.Drawing.Color.Black;
            lblbranchnameregion.Font.Bold = true;
            ...
            Label lblShift = (Label)e.Row.FindControl("lblShift");
            if (lblShift.Text == "Absent")
            {
                lblShift.ForeColor = System.Drawing.Color.Red;
                lblShift.Font.Bold = true;
            }
            else
            {
                lblShift.ForeColor = System.Drawing.Color.Green;
                lblShift.Font.Bold = true;
            }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        //}
        Response.AddHeader("content-disposition", "attachment;filename=ShortageReport-" + txtDutyDate.Text + ".xls");
        Response.Charset = "";
    ...
    protected void FillddlBranch()
    {
        ...
        ds = objsales.GetBranchfromRegion(BaseCompanyCode,ddlregion.SelectedItem.Value);
        ...
        if (ds != null)
        {
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                ddlbranch.DataValueField = "LocationDesc";
                ddlbranch.DataBind();
    ...
    protected void FillddlRegion()
    {
        DataSet ds = new DataSet();
        BL.Sales objsales = new BL.Sales();

        ds = objsales.GetRegion(BaseCompanyCode);
        ...
        if (ds != null)
        {
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                ddlregion.DataTextField = "HrLocationDesc";
                ddlregion.DataValueField = "HrLocationCode";
                ddlregion.DataBind();
