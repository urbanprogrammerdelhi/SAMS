...
function getCheckBoxListItemsChecked(elementId,hiddenFieldValue) {
    //var
    ...
    if(checkBoxArray[0].checked == true && $get(hiddenFieldValue).value.substring(0, 3)!="All")
    {
    ...
    else if(checkBoxArray[0].checked == false && $get(hiddenFieldValue).value.substring(0, 3)=="All")
    {
        for (var i = 1; i < checkBoxArray.length; i++)
        {
...
function readCheckBoxList(chkBox, ddlList, hiddenFieldText, hiddenFieldValue, hiddenFieldSelIndex) {
    ...
    var checkedItems = getCheckBoxListItemsChecked(chkBox,hiddenFieldValue);
