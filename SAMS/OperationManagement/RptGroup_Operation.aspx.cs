...
// ***********************************************************************
// <copyright file="RptGroup_Operation.aspx.cs" company="Magnon">
...
/// <summary>
/// Class OperationManagement_RptGroup_Operation.
/// </summary>
public partial class OperationManagement_RptGroup_Operation : BasePage
{
    #region Properties
    ...
    private void FillddlReportName()
    {
       ...
       /* li = new ListItem();
        ...
        ddlReportName.Items.Add(li);*/
        li = new ListItem();
        li.Text = Resources.Resource.rptMonthlyOperationsSummary.ToString();
        li.Value = "MonthlyOpsSummary";
        ddlReportName.Items.Add(li);

        li = new ListItem();
        li.Text = Resources.Resource.rptIncidentDetail.ToString();
        li.Value = "IncidentDetails";
        ddlReportName.Items.Add(li);

        li = new ListItem();
        li.Text = Resources.Resource.rptNightCheckVisitDetail.ToString();
        li.Value = "NightCheckVisitDetail";
        ddlReportName.Items.Add(li);
    ...
    private void FillddlBranch()
    {
        ...
        if (dsBranch.Tables.Count > 0 && dsBranch != null)
        {
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        if (ValidateControles(ddlReportName.SelectedItem.Value.ToString()))
        {
            ...
            Context.Items["cxtReturnPage"] = "../OperationManagement/RptGroup_Operation.aspx?ReportName=" + ddlReportName.SelectedItem.Value.ToString();
