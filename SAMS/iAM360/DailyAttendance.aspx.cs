...
public partial class iAM360_DailyAttendance : BasePage
{
    static int flag;
    #region Properties
    ...
    protected void FillgvAttendence()
    {
        ...
        var dtflag = 1;
        ds = objAssetMgmt.GetDailyAttendenceNewMilkBasketWithShift(BaseLocationAutoID, txtDutyDate.Text.Trim(), txtTodate.Text.Trim(), txtEmployeeNo.Text.Trim());
        dt = ds.Tables[0];
