...
public partial class iAM360_AllBranchesReportAP : BasePage
{
    static int flag;
    static int flagData;
    #region Properties
    ...
    protected void FillgvAttendence()
    {
        ...
        var dtflag = 1;
        ds = objAssetMgmt.GetAttendenceAPSNew(BaseLocationAutoID, txtDutyDate.Text.Trim(), txtTodate.Text.Trim(), txtEmployeeNo.Text.Trim(),  ddlbranch.SelectedItem.Value);
        //if (flagData == 2)
        //{
        //    dt = ds.Tables[2];
