<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AdvanceMusterBCFD.aspx.cs" Inherits="iAM360_AdvanceMusterBCFD" %>
                    ...
                    <asp:GridView ID="gdvData" Width="100%" CssClass="GridViewStyle" PageSize="20" runat="server" AllowPaging="true" CellPadding="2" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Duty Days" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                               ...
                               <asp:TemplateField HeaderText="Shift Hours" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                                    <center>
                                        <b>
                                            <asp:Label ID="lblshiftHrs" CssClass="cssLable" runat="server" Text='<%# Bind("ShiftHrs") %>'></asp:Label>
                                        </b>
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Over Time" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                             ...
                             <asp:TemplateField HeaderText="Short Time" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                                    <center>
                                        <b>
                                            <asp:Label ID="lblShortTime" CssClass="cssLable" runat="server" Text='<%# Bind("ShortTime") %>'></asp:Label>
                                        </b>
                                    </center>
                                </ItemTemplate>
                            </asp:TemplateField>
