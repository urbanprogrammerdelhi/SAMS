 <%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AttendanceSuper.aspx.cs" Inherits="iAM360_AttendanceSuper" %>
     ...
     <Ajax:UpdatePanel runat="server" ID="up1" UpdateMode="Conditional">
        <ContentTemplate>            
                ...
                <table align="center" width="100%" border="0" cellspacing="1px" cellpadding="1px">
                    ...
                    <tr style="background-color: #D3E8F4">
                        ...
                        <td style="text-align: right;" class="auto-style8">
                            <asp:Label ID="Label8" CssClass="cssLabel" runat="server" Text="Select Shift"></asp:Label>
                        </td>
                            <td style="text-align: left;">
                            <asp:DropDownList ID="ddlshiftFilter" Width="180px" CssClass="cssDropDown" runat="server" OnSelectedIndexChanged="ddlshiftFilter_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList>
                        </td>
                         ...
                         <td style="text-align: right;" class="auto-style6" >
                          ...
                          <td>
                           ...
                           <td style="text-align: left;" class="auto-style7">
                            <asp:TextBox ID="txtTodate" CssClass="csstxtbox" runat="server" Visible="false" Width="100px" OnTextChanged="txtTodate_TextChanged" AutoPostBack="true"></asp:TextBox>
            ...
            <div id="divGV" runat="server">
                 ...
                 OnRowEditing="gvAttendence_RowEditing" OnRowUpdating="gvAttendence_RowUpdating"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Designation" HeaderStyle-Width="300px"
                          ...
                          <asp:TemplateField HeaderText="Shift Details" HeaderStyle-Width="300px"
                            FooterStyle-Width="300px" ItemStyle-Width="300px">
                            <ItemTemplate>
                             
                                <asp:HiddenField ID="hfShiftCodevalue" runat="server" Value='<%# Bind("ShiftCode") %>' />
                                <asp:Label ID="lblShift" CssClass="cssLable" runat="server" Text='<%# Bind("ShiftDetails") %>'></asp:Label>
                            </ItemTemplate>
                             <EditItemTemplate>           
                                  <asp:HiddenField ID="hfShiftCodevalue" runat="server" Value='<%# Bind("ShiftCode") %>' />              
                            <asp:Label ID="lblShift" CssClass="cssLabel" runat="server" Text='<%# Bind("ShiftDetails") %>'></asp:Label>
                        </EditItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="In Time" HeaderStyle-Width="200px"
                        ...
                        <asp:TemplateField HeaderText="Out Time" HeaderStyle-Width="200px"
                            FooterStyle-Width="200px" ItemStyle-Width="200px">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Working Minutes" HeaderStyle-Width="250px"
                ...
                <asp:Label ID="lblerrormsgNew" runat="server" CssClass="cssLabel" ForeColor="Red" Font-Bold="true" Font-Size="Medium"  />
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtPopEmpNo" Width="200px" CssClass="csstxtbox" runat="server" AutoPostBack="true" OnTextChanged="txtPopEmpNo_TextChanged" MaxLength="20"></asp:TextBox>
                                ...
                                <%--    <tr id="tr3" runat="server" visible="false">
                                    ...
                                    <tr id="tr4" runat="server" visible="false">
                                         <td align="right">
                                            <asp:Label Width="50px" ID="Label7" CssClass="cssLabel" runat="server" Text="Select Shift"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:DropDownList ID="ddlShift" runat="server" Width="150px" ></asp:DropDownList>
                                                <asp:Label ID="lblpopupshift" runat="server" class="label label-danger" Visible="false" />
                                            </td>
                                        <td align="right">
