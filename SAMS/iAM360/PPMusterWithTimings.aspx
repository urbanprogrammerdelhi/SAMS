<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="PPMusterWithTimings.aspx.cs" Inherits="iAM360_PPMusterWithTimings" %>
        ...
        <table id="attDetail" runat="server" width="100%">
            ...
            <tr>
                ...
                <td align="left" colspan="3">
                    <br />
                    <asp:GridView ID="gdvData" Width="300%" CssClass="GridViewStyle" PageSize="20" runat="server" AllowPaging="true" CellPadding="2" GridLines="None"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="S.No." HeaderStyle-Width="50px" FooterStyle-Width="50px" ItemStyle-Width="50px">
                                <ItemTemplate>
                                    <center>
                            ...
                            <asp:TemplateField HeaderText="Emp.Code" HeaderStyle-Width="100px" FooterStyle-Width="100px" ItemStyle-Width="100px">
                                <ItemTemplate>
                                    <center>
                                        <u>
                            ...
                            <asp:TemplateField HeaderText="EmployeeName" HeaderStyle-Width="150px" FooterStyle-Width="150px" ItemStyle-Width="150px">
                                <ItemTemplate>
                                    <asp:Label ID="lblEmpName" CssClass="cssLable" runat="server" Text='<%# Bind("EmpName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Designation" HeaderStyle-Width="100px" FooterStyle-Width="100px" ItemStyle-Width="100px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Duty Days" HeaderStyle-Width="100px" FooterStyle-Width="100px" ItemStyle-Width="100px">
                                <ItemTemplate>
                                    <center>
                                        <b>
