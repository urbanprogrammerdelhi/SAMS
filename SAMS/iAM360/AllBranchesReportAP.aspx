<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AllBranchesReportAP.aspx.cs" Inherits="iAM360_AllBranchesReportAP" %>
        ...
        <ContentTemplate>            
            ...
            <div style="overflow: auto;">
                ...
                <table align="center" width="100%" border="0" cellspacing="1px" cellpadding="1px">
                  ...
                  <td>
                           <asp:Label ID="LabelCity" CssClass="cssLabel" runat="server" Text="Select Branch" Font-Bold="true" Width="80px"></asp:Label>
                     </td>
                        <td>
             ...
             <div >
                      ...
                      <asp:Button ID="btnAll" runat="server" OnClick="btnAll_Click" style="width:300px;height:70px;background-color:orange;font-size:medium;color:white" Font-Bold="true" Text="Total Employees" Visible="false"  />
                        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" style="width:300px;height:70px;background-color:green;font-size:medium;color:white" Font-Bold="true"  Text="Present" Visible="false"  />
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="width:300px;height:70px;background-color:red;font-size:medium;color:white" Font-Bold="true"  Text="Absent"  Visible="false" />
                 </div>
            <br />
                ...
                <asp:GridView ID="gvAttendence" Width="100%" CssClass="GridViewStyle" PageSize="15" runat="server" AllowPaging="true" CellPadding="1" GridLines="None"
                    ...
                    <Columns>
                     ...
                     <%--    <asp:TemplateField HeaderText="Client Name" HeaderStyle-ForeColor="White">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblbranchname" CssClass="cssLable" runat="server" Text='<%# Bind("Branch") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle  Width="350px" />
                            <ItemStyle Width="350px" />
                            <FooterStyle Width="350px" />
                     ...
                     <%--   <asp:TemplateField HeaderText="Shift Details" HeaderStyle-Width="400px"
                            FooterStyle-Width="400px" ItemStyle-Width="400px">
                            <ItemTemplate>
