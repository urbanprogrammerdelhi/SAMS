...
public partial class APS_MaxMonthlyMaterialReport :BasePage
{
    #region Declare
    int year, month;
    string months, years;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string month1 = null;
            for (int Loop = 2022; Loop <= 2022; Loop++)
            {
    ...
    private void FillData(int Year, int Month)
    {
        try
        {
            ...
            int flag = 0;
            ds = obj.MaxMaterialReport(Convert.ToInt32(BaseLocationAutoID), Year, Month);
            dt = ds.Tables[0];
            if (dt.Rows.Count == 0)
            {
    ...
    protected void gdvData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblDate32 = (Label)e.Row.FindControl("lblDate32");
            lblDate32.Attributes.Add("style", T);
            Label lblDate33 = (Label)e.Row.FindControl("lblDate33");
            lblDate33.Attributes.Add("style", T);

            Label lblDate34 = (Label)e.Row.FindControl("lblDate34");
            lblDate34.Attributes.Add("style", T);
            Label lblDate35 = (Label)e.Row.FindControl("lblDate35");
            lblDate35.Attributes.Add("style", T);
            Label lblDate36 = (Label)e.Row.FindControl("lblDate36");
            lblDate36.Attributes.Add("style", T);
            Label lblDate37 = (Label)e.Row.FindControl("lblDate37");
            lblDate37.Attributes.Add("style", T);
            Label lblDate38 = (Label)e.Row.FindControl("lblDate38");
            lblDate38.Attributes.Add("style", T);
            Label lblDate39 = (Label)e.Row.FindControl("lblDate39");
            lblDate39.Attributes.Add("style", T);
            Label lblDate40 = (Label)e.Row.FindControl("lblDate40");
            lblDate40.Attributes.Add("style", T);
            Label lblDate41 = (Label)e.Row.FindControl("lblDate41");
            lblDate41.Attributes.Add("style", T);
            Label lblDate42 = (Label)e.Row.FindControl("lblDate42");
            lblDate42.Attributes.Add("style", T);
            Label lblDate43 = (Label)e.Row.FindControl("lblDate43");
            lblDate43.Attributes.Add("style", T);
        }
    }
    protected void bntExport_Click(object sender, EventArgs e)
    {
        ...
        //else
        //{
            Response.AddHeader("content-disposition", "attachment;filename=MaxMonthlyMaterialReport-" + ddlmonth.SelectedItem.Text + ".xls");
      //  }
        Response.Charset = "";
