...
public partial class APS_MaxChecklistCopy : BasePage
{
    static int flag;
    static int dtflag;
    static int dtflag1;
   ...
   // static string AuditDate = "";
    ...
    protected void FillgvAttendence(string BranchCode,string Date)
    {
      ...
      //  ds = objAssetMgmt.GetChecklistReportMax(BaseLocationAutoID, BranchCode.ToString(), Date.ToString());
        ds = objAssetMgmt.GetChecklistReportMaxWithOutImage(BaseLocationAutoID, BranchCode.ToString(), Date.ToString());
        dt = ds.Tables[1];
        dt1 = ds.Tables[0];
    ...
    protected void gvAttendence_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblEmployeeRemarks11 = (Label)e.Row.FindControl("lblEmployeeRemarks11");
            lblEmployeeRemarks11.ForeColor = System.Drawing.Color.Black;
            lblEmployeeRemarks11.Font.Bold = true;
    ...
    {
        divupdatedetail.Visible = true;
        LinkButton objLinkButton = (LinkButton)sender;
        GridViewRow row = (GridViewRow)objLinkButton.NamingContainer;
        Label lblId = (Label)gvAttendence.Rows[row.RowIndex].FindControl("lblId");
        Label lblSection = (Label)gvAttendence.Rows[row.RowIndex].FindControl("lblEmployeeNumber");
        Label lblQuestion = (Label)gvAttendence.Rows[row.RowIndex].FindControl("lblEmployeeName");
        Label lblResponse1 = (Label)gvAttendence.Rows[row.RowIndex].FindControl("lblEmployeeRemarks");
        Label lblResponse2 = (Label)gvAttendence.Rows[row.RowIndex].FindControl("lblEmployeeRemarks11");
        Label9.Text = lblSection.Text;
        Label11.Text = lblQuestion.Text;
        txtresponse1.Text = lblResponse1.Text;
        txtresponse2.Text = lblResponse2.Text;
        checklistid.Value = lblId.Text;
    }
    ...
    protected void btnupdatedetails_Click(object sender, EventArgs e)
    {
        ...
        var ds = new DataSet();
        var dt = new DataTable();
        ds = objAssetMgmt.UpdateDetailsMax(BaseLocationAutoID,lblBranchCode.Text,Date.ToString(), checklistid.Value,txtresponse1.Text,txtresponse2.Text);
        FillgvAttendence(Branchcode,Date);
        divupdatedetail.Visible = false;
    }
