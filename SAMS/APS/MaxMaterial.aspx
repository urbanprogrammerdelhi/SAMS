<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="MaxMaterial.aspx.cs" Inherits="APS_MaxMaterial" %>
            ...
            <div id="divGV" runat="server">
                <asp:GridView ID="gvAttendence" Width="100%" CssClass="GridViewStyle" PageSize="40" runat="server" AllowPaging="true" CellPadding="1" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Per Unit price" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
