<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="MaxChecklistCopy.aspx.cs" Inherits="APS_MaxChecklistCopy" %>
    ...
    <Ajax:UpdatePanel runat="server" ID="up1" UpdateMode="Conditional">
        <ContentTemplate>            
            ...
            <div id="divGV" runat="server" visible="false">
                ...
                <br />
             <div id="divupdatedetail" runat="server" visible="false">
                 <table runat="server" class="auto-style9" >
                    <tr>
                        <td colspan="6" style="background-color:black;text-align:center"> <asp:Label Text="Edit Report Details" runat="server"  Font-Bold="true" style="color:white;text-align:center" Font-Size="Larger"  ></asp:Label></td>
                       
                    </tr>
                    <tr>
                        <td class="auto-style10"><asp:Label ID="Label8" runat="server" Text="Section : " Font-Bold="true" ForeColor="Red"></asp:Label> </td>
                         <td class="auto-style12"><asp:Label ID="Label9" runat="server" Font-Bold="true" ForeColor="Green"></asp:Label></td>
                         <td class="auto-style11"><asp:Label ID="Label10" runat="server" Text="Question : " Font-Bold="true" ForeColor="Red"></asp:Label>  </td>
                         <td><asp:Label ID="Label11" runat="server" Font-Bold="true" ForeColor="Green"></asp:Label></td>
                         <td class="auto-style12"><asp:Button ID="btnclose" runat="server" CssClass="cssButton" Text="Close" OnClick="btnclose_Click" Visible="true" /></td>
                        <td></td>
                    </tr>
                     <tr>
                        <td class="auto-style10"><asp:Label ID="Label12" runat="server" Text="Response 1 : " Font-Bold="true" ForeColor="Red"></asp:Label> </td>
                         <td class="auto-style12"><asp:TextBox ID="txtresponse1" runat="server" Font-Bold="true" ForeColor="Green" Width="200px" TextMode="MultiLine"></asp:TextBox></td>
                         <td class="auto-style11"> <asp:Label ID="Label14" runat="server" Text="Response 2 : " Font-Bold="true" ForeColor="Red"></asp:Label>  </td>
                         <td><asp:TextBox ID="txtresponse2" runat="server" Font-Bold="true" ForeColor="Green" Width="200px" TextMode="MultiLine"></asp:TextBox></td>
                          <td class="auto-style10"> <asp:Button ID="btnupdatedetails" runat="server" CssClass="cssButton" Text="Update Details" OnClick="btnupdatedetails_Click" Visible="true" /></td>
                         <td>   <asp:HiddenField ID="checklistid" runat="server" Value="0" /></td>
                    </tr>
                ...
                <asp:GridView ID="gvAttendence" Width="100%" CssClass="GridViewStyle" PageSize="45" runat="server" AllowPaging="true" CellPadding="1" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Question" HeaderStyle-ForeColor="Green">
                         ...
                         <asp:TemplateField HeaderText="Response1" HeaderStyle-ForeColor="Green">
                            <ItemTemplate>
                                <asp:Label ID="lblEmployeeRemarks" CssClass="cssLable" runat="server" Text='<%# Bind("Response1") %>'></asp:Label>
                         ...
                         <asp:TemplateField HeaderText="Response2" HeaderStyle-ForeColor="Green">
                            <ItemTemplate>
                                <asp:Label ID="lblEmployeeRemarks11" CssClass="cssLable" runat="server" Text='<%# Bind("Response2") %>'></asp:Label>                               
                            </ItemTemplate>
                            ...
                            <FooterStyle Width="300px" />
                             ...
                             <asp:TemplateField HeaderText="Edit Details" HeaderStyle-ForeColor="Green">
                            <ItemTemplate>
                              
                                <asp:LinkButton ID="lblEdit" runat="server" OnClick="lblEdit_Click" Visible="true" Text="Click Here to Edit"></asp:LinkButton>
                            </ItemTemplate>
                            <HeaderStyle CssClass="cssLabelHeader" Width="300px" />
                            <ItemStyle Width="300px" />
                            <FooterStyle Width="300px" />
                ...
                <asp:Button ID="btnExport" runat="server" CssClass="cssButton" ToolTip="<%$ Resources:Resource, ExporttoExcel %>"
                    Text=" <%$ Resources:Resource, ExporttoExcel %>" OnClick="btnExport_Click1" Visible="false" />

                  <asp:Button ID="btnExporttoPDF" runat="server" CssClass="cssButton" 
                    Text="Export to PDF" OnClick="btnExporttoPDF_Click" Visible="false" />
