<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="MaxMonthlyReportNew1.aspx.cs" Inherits="APS_MaxMonthlyReportNew1" %>
        ...
        <table id="attDetail" runat="server" width="100%">
            ...
            <tr>
                ...
                <td align="left" colspan="3">
                    <br />
                    <asp:GridView ID="gdvData" Width="550%" CssClass="GridViewStyle" PageSize="100" runat="server" AllowPaging="true" CellPadding="2" GridLines="Both"
...
the office area" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                            ...
                            <asp:TemplateField HeaderText="Red Zone Regular Extinguisher
Count - BC (CO2)- 4.5 KG." HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Red Zone Regular Extinguisher
Count - ABC- 4 KG." HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Red Zone Regular Extinguisher
Count - ABC- 2 KG." HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Status of Ceiling Mounted Clean
agent automatic Fire Extinguisher
FE36 - 5 KG (UPS/Server Room)
Green/Red." HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                          ...
                          <asp:TemplateField HeaderText="Green Zone Regular Extinguisher
Count - BC (CO2)- 4.5 KG." HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
...
Count - ABC- 2 KG." HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                            ...
                            <asp:TemplateField HeaderText="Total Count of Old Extinguishers
are kept for training
(Ceasefire/Safex/Minimax )
purpose?" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Total Count of OLD Extinguisher
are in Red Zone?" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Are old Extinguishers tagged
properly(For Training Purpose
...
exit? Upload Picture of emergency
exit if it is there" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
...
(to be checked physically)" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                            ...
                            <asp:TemplateField HeaderText="Opex Scrap status in Office Area" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Capex IT Scrap status in Office
Area" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                            ...
                            <asp:TemplateField HeaderText="Capex Non-IT Scrap status in
...
shampooing required" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                            ...
                            <asp:TemplateField HeaderText="Is the special services like Rodent
, rodent entry point closure or
termite treatment required?" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
...
around due to heat" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                              ...
                              <asp:TemplateField HeaderText="Specifying Holidays List available?" HeaderStyle-Width="300px" FooterStyle-Width="300px" ItemStyle-Width="300px">
                                <ItemTemplate>
