<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AttendanceDashboard.aspx.cs" Inherits="SAMS_AttendanceDashboard" %>
                ...
                <asp:GridView ID="gvAttendence" Width="100%" CssClass="GridViewStyle" PageSize="10" runat="server" AllowPaging="true" CellPadding="1" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Longitude" HeaderStyle-Width="300px"
                         ...
                         <asp:TemplateField HeaderText="Geo Address" HeaderStyle-Width="300px"
                            FooterStyle-Width="300px" ItemStyle-Width="300px">
                            <ItemTemplate>
                                <asp:Label ID="lblGeoAddress" CssClass="cssLable" runat="server" Text='<%# Bind("LocationName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <HeaderTemplate>
