<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AIADailyAttendance.aspx.cs" Inherits="SAMS_AIADailyAttendance" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Resource,EmployeeName %>" HeaderStyle-ForeColor="White">
                         ...
                         <asp:TemplateField HeaderText="Branch Code" HeaderStyle-ForeColor="White">
                            <ItemTemplate>
                                <asp:Label ID="lblBrnachCode" CssClass="cssLable" runat="server" Text='<%# Bind("ClientCode") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle  Width="300px" />
                            <ItemStyle Width="300px" />
                            <FooterStyle Width="300px" />
