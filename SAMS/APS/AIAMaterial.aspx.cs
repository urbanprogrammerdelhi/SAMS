...
public partial class APS_AIAMaterial : BasePage
{
    static int flag;
    #region Properties
    ...
    protected void FillddlClientCode()
    {
        ...
        ds = objsales.GetClientDetailsTATAMaterial(BaseLocationAutoID,txtDutyDate.Text);
    ...
    protected void FillgvAttendence()
    {
        ...
        var dtflag = 1;
        ds = objAssetMgmt.GetMaterialReport(BaseLocationAutoID, ddlClientCode.SelectedItem.Value, txtDutyDate.Text.Trim());
        dt = ds.Tables[0];
